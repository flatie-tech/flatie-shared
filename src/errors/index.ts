export const BACKEND_ERROR_CODES = {
  ...
  BOARD_COLUMN_NOT_FOUND: 'BOARD_COLUMN_NOT_FOUND',
  BOARD_COLUMN_NOT_EMPTY: 'BOARD_COLUMN_NOT_EMPTY',
  ...
  LAST_PLATFORM_ADMIN_REMOVAL_DENIED: 'LAST_PLATFORM_ADMIN_REMOVAL_DENIED',
  SELF_MEMBERSHIP_REMOVAL_DENIED: 'SELF_MEMBERSHIP_REMOVAL_DENIED',
  SELF_ACCOUNT_DELETION_DENIED: 'SELF_ACCOUNT_DELETION_DENIED',
  ...
  /** Enterprise tier has no catalog price — a negotiated per-unit price is required. */
  ...
  DSAR_REQUEST_NOT_FOUND: 'DSAR_REQUEST_NOT_FOUND',
  DSAR_SUBJECT_NOT_LINKED: 'DSAR_SUBJECT_NOT_LINKED',
...
export function isBackendErrorCode(code: unknown): code is BackendErrorCode {
  return (
    typeof code === 'string' &&
    Object.values(BACKEND_ERROR_CODES).includes(code as BackendErrorCode)
  );
}
