...
var ROLE_TRANSLATION_KEYS = {
  // Building roles
  [chunk73OVMLNV_cjs.BuildingRole.OWNER_REPRESENTATIVE]: "roles.OWNER_REPRESENTATIVE",
  [chunk73OVMLNV_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: "roles.DEPUTY_REPRESENTATIVE",
  [chunk73OVMLNV_cjs.BuildingRole.CO_OWNER]: "roles.CO_OWNER",
  [chunk73OVMLNV_cjs.BuildingRole.RESIDENT]: "roles.RESIDENT",
  // Org roles
  [chunk73OVMLNV_cjs.OrgRole.ORG_ADMIN]: "roles.ORG_ADMIN",
  [chunk73OVMLNV_cjs.OrgRole.SUPERVISOR]: "roles.SUPERVISOR",
  [chunk73OVMLNV_cjs.OrgRole.REFERENT]: "roles.REFERENT",
  [chunk73OVMLNV_cjs.OrgRole.OPERATIVE]: "roles.OPERATIVE",
  // Platform roles
  [chunk73OVMLNV_cjs.PlatformRole.PLATFORM_ADMIN]: "roles.PLATFORM_ADMIN",
  [chunk73OVMLNV_cjs.PlatformRole.PLATFORM_MODERATOR]: "roles.PLATFORM_MODERATOR",
  [chunk73OVMLNV_cjs.PlatformRole.PLATFORM_SUPPORT]: "roles.PLATFORM_SUPPORT",
  [chunk73OVMLNV_cjs.PlatformRole.PLATFORM_OPERATIVE]: "roles.PLATFORM_OPERATIVE"
};
var ROLE_DESCRIPTION_KEYS = {
  [chunk73OVMLNV_cjs.BuildingRole.OWNER_REPRESENTATIVE]: "roles.OWNER_REPRESENTATIVE_DESC",
  [chunk73OVMLNV_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: "roles.DEPUTY_REPRESENTATIVE_DESC",
  [chunk73OVMLNV_cjs.BuildingRole.CO_OWNER]: "roles.CO_OWNER_DESC",
  [chunk73OVMLNV_cjs.BuildingRole.RESIDENT]: "roles.RESIDENT_DESC",
  [chunk73OVMLNV_cjs.OrgRole.ORG_ADMIN]: "roles.ORG_ADMIN_DESC",
  [chunk73OVMLNV_cjs.OrgRole.SUPERVISOR]: "roles.SUPERVISOR_DESC",
  [chunk73OVMLNV_cjs.OrgRole.REFERENT]: "roles.REFERENT_DESC",
  [chunk73OVMLNV_cjs.OrgRole.OPERATIVE]: "roles.OPERATIVE_DESC",
  [chunk73OVMLNV_cjs.PlatformRole.PLATFORM_ADMIN]: "roles.PLATFORM_ADMIN_DESC",
  [chunk73OVMLNV_cjs.PlatformRole.PLATFORM_MODERATOR]: "roles.PLATFORM_MODERATOR_DESC",
  [chunk73OVMLNV_cjs.PlatformRole.PLATFORM_SUPPORT]: "roles.PLATFORM_SUPPORT_DESC",
  [chunk73OVMLNV_cjs.PlatformRole.PLATFORM_OPERATIVE]: "roles.PLATFORM_OPERATIVE_DESC"
};
var ROLE_BADGE_COLORS = {
  // Building roles
  [chunk73OVMLNV_cjs.BuildingRole.OWNER_REPRESENTATIVE]: "info",
  [chunk73OVMLNV_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: "success",
  [chunk73OVMLNV_cjs.BuildingRole.CO_OWNER]: "warning",
  [chunk73OVMLNV_cjs.BuildingRole.RESIDENT]: "neutral",
  // Org roles
  [chunk73OVMLNV_cjs.OrgRole.ORG_ADMIN]: "purple",
  [chunk73OVMLNV_cjs.OrgRole.SUPERVISOR]: "info",
  [chunk73OVMLNV_cjs.OrgRole.REFERENT]: "success",
  [chunk73OVMLNV_cjs.OrgRole.OPERATIVE]: "amber",
  // Platform roles
  [chunk73OVMLNV_cjs.PlatformRole.PLATFORM_ADMIN]: "purple",
  [chunk73OVMLNV_cjs.PlatformRole.PLATFORM_MODERATOR]: "info",
  [chunk73OVMLNV_cjs.PlatformRole.PLATFORM_SUPPORT]: "success",
  [chunk73OVMLNV_cjs.PlatformRole.PLATFORM_OPERATIVE]: "amber"
};
...
function isFeatureAvailable({
  ...
  const meta = chunk73OVMLNV_cjs.PLATFORM_FEATURE_META[feature];
...
function canDoOnResource(subject, domain, action, resourceOwnerId) {
  const scopedPerms = chunk73OVMLNV_cjs.SCOPED_PERMISSIONS[domain]?.[action];
...
function computeActionFlags(subject, domain, resourceOwnerId) {
  const approvePermission = chunk73OVMLNV_cjs.APPROVE_PERMISSIONS[domain];
  return {
...
//# sourceMappingURL=chunk-M7YQSS4A.cjs.map
//# sourceMappingURL=chunk-M7YQSS4A.cjs.map