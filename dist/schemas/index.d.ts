 ...
 */
declare const booleanish: z.ZodPipe<z.ZodUnion<readonly [z.ZodBoolean, z.ZodLiteral<"true">, z.ZodLiteral<"false">]>, z.ZodTransform<boolean, boolean | "true" | "false">>;
/**
 ...
 */
declare const BUG_REPORT_STATUSES: readonly ["new", "in_review", "resolved", "dismissed"];
type BugReportStatus = (typeof BUG_REPORT_STATUSES)[number];
declare const bugReportStatusSchema: z.ZodEnum<{
    dismissed: "dismissed";
    resolved: "resolved";
    new: "new";
    in_review: "in_review";
}>;
declare const BUG_REPORT_LIMITS: {
    readonly TITLE_MAX: 120;
    readonly DESCRIPTION_MAX: 4000;
    readonly URL_MAX: 1000;
    readonly NOTE_MAX: 1000;
};
declare const createBugReportSchema: z.ZodObject<{
    title: z.ZodString;
    description: z.ZodString;
    url: z.ZodString;
    viewport: z.ZodOptional<z.ZodString>;
}, z.core.$strip>;
type CreateBugReportSchema = z.infer<typeof createBugReportSchema>;
declare const updateBugReportSchema: z.ZodObject<{
    ...
    adminNote: z.ZodNullable<z.ZodOptional<z.ZodString>>;
}, z.core.$strip>;
type UpdateBugReportSchema = z.infer<typeof updateBugReportSchema>;
declare const bugReportResponseSchema: z.ZodObject<{
    id: z.ZodString;
    title: z.ZodString;
    description: z.ZodString;
    url: z.ZodString;
    ...
    reporterName: z.ZodNullable<z.ZodString>;
...
declare const listBugReportsResponseSchema: z.ZodObject<{
...
type BugReportResponse = z.infer<typeof bugReportResponseSchema>;
type ListBugReportsResponse = z.infer<typeof listBugReportsResponseSchema>;
...
declare const feeModelSchema: z.ZodEnum<{
    flat: "flat";
    per_unit: "per_unit";
    per_sqm: "per_sqm";
}>;
declare const managementInvoiceStatusSchema: z.ZodEnum<{
    cancelled: "cancelled";
    issued: "issued";
    paid: "paid";
}>;
declare const managementInvoiceSchema: z.ZodObject<{
    id: z.ZodString;
    orgId: z.ZodString;
    buildingId: z.ZodString;
    ...
    unitPrice: z.ZodPipe<z.ZodPipe<z.ZodUnion<readonly [z.ZodString, z.ZodNumber]>, z.ZodTransform<string, string | number>>, z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>>;
    netAmount: z.ZodPipe<z.ZodPipe<z.ZodUnion<readonly [z.ZodString, z.ZodNumber]>, z.ZodTransform<string, string | number>>, z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>>;
    vatRate: z.ZodNumber;
    vatAmount: z.ZodPipe<z.ZodPipe<z.ZodUnion<readonly [z.ZodString, z.ZodNumber]>, z.ZodTransform<string, string | number>>, z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>>;
    grossAmount: z.ZodPipe<z.ZodPipe<z.ZodUnion<readonly [z.ZodString, z.ZodNumber]>, z.ZodTransform<string, string | number>>, z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>>;
    currency: z.ZodString;
    model: z.ZodString;
    reference: z.ZodString;
    supplierName: z.ZodString;
    supplierOib: z.ZodNullable<z.ZodString>;
    supplierAddress: z.ZodNullable<z.ZodString>;
    supplierIban: z.ZodString;
    customerName: z.ZodString;
    customerOib: z.ZodNullable<z.ZodString>;
    ...
    fileId: z.ZodNullable<z.ZodString>;
    emailSentAt: z.ZodNullable<z.ZodString>;
    eposlovanjeId: z.ZodNullable<z.ZodNumber>;
    eposlovanjeStatus: z.ZodNullable<z.ZodNumber>;
    sentToEposlovanjeAt: z.ZodNullable<z.ZodString>;
    canMarkPaid: z.ZodBoolean;
    canCancel: z.ZodBoolean;
    canSendEracun: z.ZodBoolean;
}, z.core.$strip>;
type ManagementInvoice = z.infer<typeof managementInvoiceSchema>;
declare const managementInvoiceListQuerySchema: z.ZodObject<{
    status: z.ZodOptional<z.ZodEnum<{
        cancelled: "cancelled";
        issued: "issued";
        paid: "paid";
...
type ManagementInvoiceListQuery = z.infer<typeof managementInvoiceListQuerySchema>;
declare const managementInvoiceListResponseSchema: z.ZodObject<{
...
declare const managementInvoiceSummarySchema: z.ZodObject<{
    issuedThisMonth: z.ZodPipe<z.ZodPipe<z.ZodUnion<readonly [z.ZodString, z.ZodNumber]>, z.ZodTransform<string, string | number>>, z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>>;
    openTotal: z.ZodPipe<z.ZodPipe<z.ZodUnion<readonly [z.ZodString, z.ZodNumber]>, z.ZodTransform<string, string | number>>, z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>>;
    overdueTotal: z.ZodPipe<z.ZodPipe<z.ZodUnion<readonly [z.ZodString, z.ZodNumber]>, z.ZodTransform<string, string | number>>, z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>>;
    paidYtd: z.ZodPipe<z.ZodPipe<z.ZodUnion<readonly [z.ZodString, z.ZodNumber]>, z.ZodTransform<string, string | number>>, z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>>;
    openCount: z.ZodNumber;
    overdueCount: z.ZodNumber;
}, z.core.$strip>;
type ManagementInvoiceSummary = z.infer<typeof managementInvoiceSummarySchema>;
declare const previewManagementInvoicesSchema: z.ZodObject<{
    period: z.ZodString;
    buildingIds: z.ZodOptional<z.ZodArray<z.ZodString>>;
}, z.core.$strip>;
type PreviewManagementInvoicesSchema = z.infer<typeof previewManagementInvoicesSchema>;
/** Why a building cannot be invoiced for the period. */
declare const InvoiceBlocker: {
    readonly NO_FEE: "no_fee";
    readonly BUILDING_OIB_MISSING: "building_oib_missing";
    readonly ALREADY_ISSUED: "already_issued";
    readonly ORG_IDENTITY_INCOMPLETE: "org_identity_incomplete";
    readonly ZERO_QUANTITY: "zero_quantity";
};
type InvoiceBlocker = (typeof InvoiceBlocker)[keyof typeof InvoiceBlocker];
declare const managementInvoicePreviewRowSchema: z.ZodObject<{
    buildingId: z.ZodString;
    buildingName: z.ZodString;
    feeModel: z.ZodNullable<z.ZodEnum<{
        flat: "flat";
        per_unit: "per_unit";
        per_sqm: "per_sqm";
    }>>;
    quantity: z.ZodString;
    unitPrice: z.ZodNullable<z.ZodPipe<z.ZodPipe<z.ZodUnion<readonly [z.ZodString, z.ZodNumber]>, z.ZodTransform<string, string | number>>, z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>>>;
    netAmount: z.ZodPipe<z.ZodPipe<z.ZodUnion<readonly [z.ZodString, z.ZodNumber]>, z.ZodTransform<string, string | number>>, z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>>;
    vatRate: z.ZodNumber;
    vatAmount: z.ZodPipe<z.ZodPipe<z.ZodUnion<readonly [z.ZodString, z.ZodNumber]>, z.ZodTransform<string, string | number>>, z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>>;
    grossAmount: z.ZodPipe<z.ZodPipe<z.ZodUnion<readonly [z.ZodString, z.ZodNumber]>, z.ZodTransform<string, string | number>>, z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>>;
    blocker: z.ZodNullable<z.ZodEnum<{
        no_fee: "no_fee";
    ...
    existingInvoiceId: z.ZodNullable<z.ZodString>;
}, z.core.$strip>;
declare const previewManagementInvoicesResponseSchema: z.ZodObject<{
    orgId: z.ZodString;
    period: z.ZodString;
    identityComplete: z.ZodBoolean;
    missingIdentityFields: z.ZodArray<z.ZodString>;
    rows: z.ZodArray<z.ZodObject<{
        buildingId: z.ZodString;
        buildingName: z.ZodString;
        feeModel: z.ZodNullable<z.ZodEnum<{
    ...
    issuableCount: z.ZodNumber;
    totalGross: z.ZodPipe<z.ZodPipe<z.ZodUnion<readonly [z.ZodString, z.ZodNumber]>, z.ZodTransform<string, string | number>>, z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>>;
}, z.core.$strip>;
type PreviewManagementInvoicesResponse = z.infer<typeof previewManagementInvoicesResponseSchema>;
type ManagementInvoicePreviewRow = z.infer<typeof managementInvoicePreviewRowSchema>;
declare const issueManagementInvoicesSchema: z.ZodObject<{
    period: z.ZodString;
    buildingIds: z.ZodArray<z.ZodString>;
    sendEmail: z.ZodOptional<z.ZodBoolean>;
}, z.core.$strip>;
type IssueManagementInvoicesSchema = z.infer<typeof issueManagementInvoicesSchema>;
declare const issueManagementInvoicesResponseSchema: z.ZodObject<{
    issued: z.ZodArray<z.ZodObject<{
        id: z.ZodString;
        orgId: z.ZodString;
        buildingId: z.ZodString;
...
type IssueManagementInvoicesResponse = z.infer<typeof issueManagementInvoicesResponseSchema>;
declare const markManagementInvoicePaidSchema: z.ZodObject<{
    paidAt: z.ZodOptional<z.ZodString>;
    recordExpense: z.ZodOptional<z.ZodBoolean>;
}, z.core.$strip>;
type MarkManagementInvoicePaidSchema = z.infer<typeof markManagementInvoicePaidSchema>;
declare const cancelManagementInvoiceSchema: z.ZodObject<{
    reason: z.ZodString;
}, z.core.$strip>;
type CancelManagementInvoiceSchema = z.infer<typeof cancelManagementInvoiceSchema>;
/** Building-side list (reps / co-owners see the invoices addressed to their building). */
declare const buildingManagementInvoicesResponseSchema: z.ZodObject<{
    buildingId: z.ZodString;
...
type BuildingManagementInvoicesResponse = z.infer<typeof buildingManagementInvoicesResponseSchema>;
...
declare const orgAiImportBuildingSchema: z.ZodObject<{
...
declare const orgAiImportAddressCandidateSchema: z.ZodObject<{
    addressId: z.ZodString;
    fullAddress: z.ZodString;
}, z.core.$strip>;
declare const orgAiImportExtractResponseSchema: z.ZodObject<{
    ...
    addressCandidates: z.ZodArray<z.ZodObject<{
        addressId: z.ZodString;
        fullAddress: z.ZodString;
    }, z.core.$strip>>;
    unitCount: z.ZodNumber;
    ownerCount: z.ZodNumber;
    pagesProcessed: z.ZodNumber;
    extractionWarnings: z.ZodArray<z.ZodString>;
}, z.core.$strip>;
declare const orgAiImportCommitSchema: z.ZodObject<{
    extractionId: z.ZodString;
    name: z.ZodString;
...
type OrgAiImportCommitSchema = z.infer<typeof orgAiImportCommitSchema>;
declare const orgAiImportSkippedRowSchema: z.ZodObject<{
    unitLabel: z.ZodString;
    errors: z.ZodArray<z.ZodString>;
}, z.core.$strip>;
declare const orgAiImportCommitResponseSchema: z.ZodObject<{
    buildingId: z.ZodString;
    unitsCreated: z.ZodNumber;
    ownersCreated: z.ZodNumber;
    assignmentsCreated: z.ZodNumber;
    skippedRows: z.ZodArray<z.ZodObject<{
        unitLabel: z.ZodString;
        errors: z.ZodArray<z.ZodString>;
    }, z.core.$strip>>;
}, z.core.$strip>;
type OrgAiImportBuilding = z.infer<typeof orgAiImportBuildingSchema>;
type OrgAiImportExtractResponse = z.infer<typeof orgAiImportExtractResponseSchema>;
type OrgAiImportCommitResponse = z.infer<typeof orgAiImportCommitResponseSchema>;

declare const orgDunningBuildingRowSchema: z.ZodObject<{
    buildingId: z.ZodString;
    buildingName: z.ZodString;
    dunningEnabled: z.ZodBoolean;
    trackingActive: z.ZodBoolean;
    totalOverdue: z.ZodNumber;
    debtors: z.ZodNumber;
    readyReminder: z.ZodNumber;
    readyFinal: z.ZodNumber;
    readyNeverBilled: z.ZodNumber;
    openCases: z.ZodNumber;
    inEnforcement: z.ZodNumber;
    lastNoticeAt: z.ZodNullable<z.ZodString>;
}, z.core.$strip>;
type OrgDunningBuildingRow = z.infer<typeof orgDunningBuildingRowSchema>;
declare const orgDunningOverviewResponseSchema: z.ZodObject<{
    orgId: z.ZodString;
    asOf: z.ZodString;
    rows: z.ZodArray<z.ZodObject<{
        buildingId: z.ZodString;
    ...
    openCases: z.ZodNumber;
    inEnforcement: z.ZodNumber;
    buildingsEnabled: z.ZodNumber;
}, z.core.$strip>;
type OrgDunningOverviewResponse = z.infer<typeof orgDunningOverviewResponseSchema>;
declare const orgDunningQuerySchema: z.ZodObject<{
    asOf: z.ZodOptional<z.ZodString>;
}, z.core.$strip>;
type OrgDunningQuery = z.infer<typeof orgDunningQuerySchema>;
declare const issueOrgDunningSchema: z.ZodObject<{
    buildingIds: z.ZodOptional<z.ZodArray<z.ZodString>>;
    channel: z.ZodEnum<{
        email: "email";
        download: "download";
...
type IssueOrgDunning = z.infer<typeof issueOrgDunningSchema>;
declare const OrgDunningIssueStatus: {
    readonly DONE: "done";
    readonly SKIPPED: "skipped";
};
type OrgDunningIssueStatus = (typeof OrgDunningIssueStatus)[keyof typeof OrgDunningIssueStatus];
declare const orgDunningIssueResultSchema: z.ZodObject<{
    buildingId: z.ZodString;
    buildingName: z.ZodString;
    status: z.ZodEnum<{
        readonly DONE: "done";
    ...
    issued: z.ZodNumber;
    issuedReminder: z.ZodNumber;
    issuedFinal: z.ZodNumber;
    skipped: z.ZodNumber;
    totalAmount: z.ZodNumber;
}, z.core.$strip>;
type OrgDunningIssueResult = z.infer<typeof orgDunningIssueResultSchema>;
declare const issueOrgDunningResponseSchema: z.ZodObject<{
    asOf: z.ZodString;
    channel: z.ZodEnum<{
        email: "email";
        download: "download";
    ...
    buildingsDone: z.ZodNumber;
    buildingsSkipped: z.ZodNumber;
    issued: z.ZodNumber;
    skipped: z.ZodNumber;
    totalAmount: z.ZodNumber;
    batchIds: z.ZodArray<z.ZodString>;
}, z.core.$strip>;
type IssueOrgDunningResponse = z.infer<typeof issueOrgDunningResponseSchema>;
declare const orgDunningZipQuerySchema: z.ZodObject<{
    batchIds: z.ZodString;
}, z.core.$strip>;
type OrgDunningZipQuery = z.infer<typeof orgDunningZipQuerySchema>;
...
declare const OrgUplatniceBlocker: {
    /** `monthlyFeePerSqm` not set — every slip would price at 0. */
    readonly NO_FEE_RATE: "no_fee_rate";
    readonly NO_IBAN: "no_iban";
    readonly NO_OIB: "no_oib";
    /** `billingBuildingCode` missing — first HR01 reference segment. */
    readonly NO_BILLING_CODE: "no_billing_code";
    /** Configured, but no unit/owner carries a payment reference yet. */
    readonly NO_PAYERS: "no_payers";
};
type OrgUplatniceBlocker = (typeof OrgUplatniceBlocker)[keyof typeof OrgUplatniceBlocker];
declare const orgUplatniceBuildingRowSchema: z.ZodObject<{
    buildingId: z.ZodString;
    buildingName: z.ZodString;
    blocker: z.ZodNullable<z.ZodEnum<{
        /** `monthlyFeePerSqm` not set — every slip would price at 0. */
    ...
    payersCount: z.ZodNumber;
    expectedTotal: z.ZodNumber;
    emailedCount: z.ZodNumber;
    generatedCount: z.ZodNumber;
    failedCount: z.ZodNumber;
    unbilledCount: z.ZodNumber;
    lastEmailedAt: z.ZodNullable<z.ZodString>;
    lastGeneratedAt: z.ZodNullable<z.ZodString>;
}, z.core.$strip>;
type OrgUplatniceBuildingRow = z.infer<typeof orgUplatniceBuildingRowSchema>;
declare const orgUplatniceOverviewResponseSchema: z.ZodObject<{
    orgId: z.ZodString;
    period: z.ZodString;
    rows: z.ZodArray<z.ZodObject<{
        buildingId: z.ZodString;
    ...
    payersTotal: z.ZodNumber;
    expectedTotal: z.ZodNumber;
    emailedTotal: z.ZodNumber;
    unbilledTotal: z.ZodNumber;
}, z.core.$strip>;
type OrgUplatniceOverviewResponse = z.infer<typeof orgUplatniceOverviewResponseSchema>;
declare const orgUplatniceQuerySchema: z.ZodObject<{
    period: z.ZodOptional<z.ZodString>;
    buildingIds: z.ZodOptional<z.ZodString>;
}, z.core.$strip>;
type OrgUplatniceQuery = z.infer<typeof orgUplatniceQuerySchema>;
declare const sendOrgUplatniceSchema: z.ZodObject<{
    period: z.ZodString;
    buildingIds: z.ZodOptional<z.ZodArray<z.ZodString>>;
}, z.core.$strip>;
type SendOrgUplatnice = z.infer<typeof sendOrgUplatniceSchema>;
declare const OrgUplatniceSendStatus: {
    readonly DONE: "done";
    readonly SKIPPED: "skipped";
};
type OrgUplatniceSendStatus = (typeof OrgUplatniceSendStatus)[keyof typeof OrgUplatniceSendStatus];
declare const orgUplatniceSendResultSchema: z.ZodObject<{
    buildingId: z.ZodString;
    buildingName: z.ZodString;
    status: z.ZodEnum<{
        readonly DONE: "done";
...
type OrgUplatniceSendResult = z.infer<typeof orgUplatniceSendResultSchema>;
declare const sendOrgUplatniceResponseSchema: z.ZodObject<{
    period: z.ZodString;
    results: z.ZodArray<z.ZodObject<{
        buildingId: z.ZodString;
        buildingName: z.ZodString;
...
type SendOrgUplatniceResponse = z.infer<typeof sendOrgUplatniceResponseSchema>;
 ...
 */
declare const organizationInvoicingIdentitySchema: z.ZodObject<{
    ...
    courtRegister: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    invoiceBusinessUnitCode: z.ZodOptional<z.ZodString>;
    invoiceDeviceCode: z.ZodOptional<z.ZodString>;
    invoiceDueDays: z.ZodOptional<z.ZodNumber>;
    invoiceFooter: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    eposlovanjeApiKey: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    autoIssueInvoices: z.ZodOptional<z.ZodBoolean>;
}, z.core.$strip>;
type OrganizationInvoicingIdentitySchema = z.infer<typeof organizationInvoicingIdentitySchema>;
...
declare const assignOrgBuildingSchema: z.ZodObject<{
    ...
    feeModel: z.ZodOptional<z.ZodNullable<z.ZodEnum<{
        flat: "flat";
        per_unit: "per_unit";
        per_sqm: "per_sqm";
    }>>>;
    feeAmount: z.ZodOptional<z.ZodNullable<z.ZodPipe<z.ZodPipe<z.ZodUnion<readonly [z.ZodString, z.ZodNumber]>, z.ZodTransform<string, string | number>>, z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>>>>;
    feeVatRate: z.ZodOptional<z.ZodNullable<z.ZodNumber>>;
    feeNote: z.ZodOptional<z.ZodNullable<z.ZodString>>;
}, z.core.$strip>;
/**
...
declare const pricuvaOpeningBalanceRowSchema: z.ZodObject<{
    ownerId: z.ZodString;
    ownerName: z.ZodString;
    amount: z.ZodNumber;
    note: z.ZodNullable<z.ZodString>;
...
declare const pricuvaOpeningBalancesResponseSchema: z.ZodObject<{
    buildingId: z.ZodString;
    rows: z.ZodArray<z.ZodObject<{
        ownerId: z.ZodString;
        ownerName: z.ZodString;
 ...
 */
declare const upsertPricuvaOpeningBalancesSchema: z.ZodObject<{
...
type UpsertPricuvaOpeningBalancesSchema = z.infer<typeof upsertPricuvaOpeningBalancesSchema>;
/** Result of a manual "post due charges now" run for one building. */
declare const postPricuvaChargesResponseSchema: z.ZodObject<{
    postedPeriods: z.ZodArray<z.ZodString>;
    chargesPosted: z.ZodNumber;
}, z.core.$strip>;
type PricuvaOpeningBalanceRow = z.infer<typeof pricuvaOpeningBalanceRowSchema>;
type PricuvaOpeningBalancesResponse = z.infer<typeof pricuvaOpeningBalancesResponseSchema>;
...
declare const getAuditLogsQuerySchema: z.ZodObject<{
    ...
    fromDate: z.ZodOptional<z.ZodString>;
    toDate: z.ZodOptional<z.ZodString>;
    includeDenials: z.ZodOptional<z.ZodPipe<z.ZodUnion<readonly [z.ZodBoolean, z.ZodLiteral<"true">, z.ZodLiteral<"false">]>, z.ZodTransform<boolean, boolean | "true" | "false">>>;
    denialsOnly: z.ZodOptional<z.ZodPipe<z.ZodUnion<readonly [z.ZodBoolean, z.ZodLiteral<"true">, z.ZodLiteral<"false">]>, z.ZodTransform<boolean, boolean | "true" | "false">>>;
    limit: z.ZodOptional<z.ZodCoercedNumber<unknown>>;
...
declare const createBuildingSchema: z.ZodObject<{
    ...
    iban: z.ZodNullable<z.ZodOptional<z.ZodString>>;
    oib: z.ZodNullable<z.ZodOptional<z.ZodString>>;
    monthlyFeePerSqm: z.ZodOptional<z.ZodPipe<z.ZodTransform<{} | null | undefined, unknown>, z.ZodNullable<z.ZodCoercedNumber<unknown>>>>;
    monthlyFeeCommercialPerSqm: z.ZodOptional<z.ZodPipe<z.ZodTransform<{} | null | undefined, unknown>, z.ZodNullable<z.ZodCoercedNumber<unknown>>>>;
    apartmentResidentialCoef: z.ZodOptional<z.ZodPipe<z.ZodTransform<{} | null | undefined, unknown>, z.ZodOptional<z.ZodCoercedNumber<unknown>>>>;
    apartmentCommercialCoef: z.ZodOptional<z.ZodPipe<z.ZodTransform<{} | null | undefined, unknown>, z.ZodOptional<z.ZodCoercedNumber<unknown>>>>;
    garageResidentialCoef: z.ZodOptional<z.ZodPipe<z.ZodTransform<{} | null | undefined, unknown>, z.ZodOptional<z.ZodCoercedNumber<unknown>>>>;
    garageCommercialCoef: z.ZodOptional<z.ZodPipe<z.ZodTransform<{} | null | undefined, unknown>, z.ZodOptional<z.ZodCoercedNumber<unknown>>>>;
    storageResidentialCoef: z.ZodOptional<z.ZodPipe<z.ZodTransform<{} | null | undefined, unknown>, z.ZodOptional<z.ZodCoercedNumber<unknown>>>>;
    storageCommercialCoef: z.ZodOptional<z.ZodPipe<z.ZodTransform<{} | null | undefined, unknown>, z.ZodOptional<z.ZodCoercedNumber<unknown>>>>;
...
declare const updateBuildingSchema: z.ZodObject<{
    ...
    pricuvaTrackingFrom: z.ZodNullable<z.ZodOptional<z.ZodString>>;
}, z.core.$strip>;
/**
...
declare const getDsarRequestsQuerySchema: z.ZodObject<{
    ...
    overdue: z.ZodOptional<z.ZodPipe<z.ZodUnion<readonly [z.ZodBoolean, z.ZodLiteral<"true">, z.ZodLiteral<"false">]>, z.ZodTransform<boolean, boolean | "true" | "false">>>;
    search: z.ZodOptional<z.ZodString>;
    limit: z.ZodOptional<z.ZodCoercedNumber<unknown>>;
    offset: z.ZodOptional<z.ZodCoercedNumber<unknown>>;
}, z.core.$strip>;
 ...
 * element).
 */
declare const failureReportEventWithDateOrderSchema: z.ZodObject<{
    startDate: z.ZodCoercedDate<unknown>;
    endDate: z.ZodCoercedDate<unknown>;
    title: z.ZodOptional<z.ZodString>;
    description: z.ZodOptional<z.ZodString>;
 ...
 */
declare const noticeEventWithDateOrderSchema: z.ZodObject<{
    id: z.ZodOptional<z.ZodString>;
    startDate: z.ZodCoercedDate<unknown>;
    endDate: z.ZodCoercedDate<unknown>;
    title: z.ZodOptional<z.ZodString>;
...
declare const getPlatformSubscriptionsQuerySchema: z.ZodObject<{
    ...
    trialing: z.ZodOptional<z.ZodPipe<z.ZodUnion<readonly [z.ZodBoolean, z.ZodLiteral<"true">, z.ZodLiteral<"false">]>, z.ZodTransform<boolean, boolean | "true" | "false">>>;
    search: z.ZodOptional<z.ZodString>;
...
declare const buildingDetailResponseSchema: z.ZodObject<{
    ...
    monthlyFeePerSqm: z.ZodOptional<z.ZodNullable<z.ZodNumber>>;
    monthlyFeeCommercialPerSqm: z.ZodOptional<z.ZodNullable<z.ZodNumber>>;
    pricuvaTrackingFrom: z.ZodOptional<z.ZodNullable<z.ZodString>>;
...
declare const buildingFundsLedgerRowSchema: z.ZodObject<{
    ...
    chargedTotal: z.ZodOptional<z.ZodNumber>;
    paidSinceStart: z.ZodOptional<z.ZodNumber>;
 ...
 */
declare const orgStatementImportResultSchema: z.ZodObject<{
    buildingId: z.ZodString;
    buildingName: z.ZodString;
    iban: z.ZodString;
    ...
    status: z.ZodEnum<{
        imported: "imported";
        not_camt_mode: "not_camt_mode";
    }>;
    importedCount: z.ZodNumber;
    skippedCount: z.ZodNumber;
    errorCount: z.ZodNumber;
}, z.core.$strip>;
declare const orgStatementImportResponseSchema: z.ZodObject<{
    results: z.ZodArray<z.ZodObject<{
        buildingId: z.ZodString;
        buildingName: z.ZodString;
        iban: z.ZodString;
    ...
    unmatchedIbans: z.ZodArray<z.ZodObject<{
        iban: z.ZodString;
        statements: z.ZodNumber;
        entries: z.ZodNumber;
    }, z.core.$strip>>;
}, z.core.$strip>;
type OrgStatementImportResult = Strict<z.infer<typeof orgStatementImportResultSchema>>;
type OrgStatementImportResponse = Strict<z.infer<typeof orgStatementImportResponseSchema>>;
/**
 ...
 */
declare const unmatchedPricuvaRefRowSchema: z.ZodObject<{
    refCode: z.ZodString;
    count: z.ZodNumber;
    totalAmount: z.ZodNumber;
    firstPeriod: z.ZodNullable<z.ZodString>;
    lastPeriod: z.ZodNullable<z.ZodString>;
    samplePayer: z.ZodNullable<z.ZodString>;
}, z.core.$strip>;
declare const unmatchedPricuvaRefsResponseSchema: z.ZodObject<{
    buildingId: z.ZodString;
    rows: z.ZodArray<z.ZodObject<{
        refCode: z.ZodString;
        count: z.ZodNumber;
...
declare const mapPricuvaRefSchema: z.ZodObject<{
    refCode: z.ZodString;
    unitId: z.ZodString;
}, z.core.$strip>;
declare const mapPricuvaRefResponseSchema: z.ZodObject<{
    unitId: z.ZodString;
    refCode: z.ZodString;
    linkedCount: z.ZodNumber;
}, z.core.$strip>;
type UnmatchedPricuvaRefsResponse = Strict<z.infer<typeof unmatchedPricuvaRefsResponseSchema>>;
type MapPricuvaRefSchema = z.infer<typeof mapPricuvaRefSchema>;
type MapPricuvaRefResponse = Strict<z.infer<typeof mapPricuvaRefResponseSchema>>;
