...
var ROLE_TRANSLATION_KEYS = {
  // Building roles
  [chunkDSQZHRUF_cjs.BuildingRole.OWNER_REPRESENTATIVE]: "roles.OWNER_REPRESENTATIVE",
  [chunkDSQZHRUF_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: "roles.DEPUTY_REPRESENTATIVE",
  [chunkDSQZHRUF_cjs.BuildingRole.CO_OWNER]: "roles.CO_OWNER",
  [chunkDSQZHRUF_cjs.BuildingRole.RESIDENT]: "roles.RESIDENT",
  // Org roles
  [chunkDSQZHRUF_cjs.OrgRole.ORG_ADMIN]: "roles.ORG_ADMIN",
  [chunkDSQZHRUF_cjs.OrgRole.SUPERVISOR]: "roles.SUPERVISOR",
  [chunkDSQZHRUF_cjs.OrgRole.REFERENT]: "roles.REFERENT",
  [chunkDSQZHRUF_cjs.OrgRole.OPERATIVE]: "roles.OPERATIVE",
  // Platform roles
  [chunkDSQZHRUF_cjs.PlatformRole.PLATFORM_ADMIN]: "roles.PLATFORM_ADMIN",
  [chunkDSQZHRUF_cjs.PlatformRole.PLATFORM_MODERATOR]: "roles.PLATFORM_MODERATOR",
  [chunkDSQZHRUF_cjs.PlatformRole.PLATFORM_SUPPORT]: "roles.PLATFORM_SUPPORT",
  [chunkDSQZHRUF_cjs.PlatformRole.PLATFORM_OPERATIVE]: "roles.PLATFORM_OPERATIVE"
};
var ROLE_DESCRIPTION_KEYS = {
  [chunkDSQZHRUF_cjs.BuildingRole.OWNER_REPRESENTATIVE]: "roles.OWNER_REPRESENTATIVE_DESC",
  [chunkDSQZHRUF_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: "roles.DEPUTY_REPRESENTATIVE_DESC",
  [chunkDSQZHRUF_cjs.BuildingRole.CO_OWNER]: "roles.CO_OWNER_DESC",
  [chunkDSQZHRUF_cjs.BuildingRole.RESIDENT]: "roles.RESIDENT_DESC",
  [chunkDSQZHRUF_cjs.OrgRole.ORG_ADMIN]: "roles.ORG_ADMIN_DESC",
  [chunkDSQZHRUF_cjs.OrgRole.SUPERVISOR]: "roles.SUPERVISOR_DESC",
  [chunkDSQZHRUF_cjs.OrgRole.REFERENT]: "roles.REFERENT_DESC",
  [chunkDSQZHRUF_cjs.OrgRole.OPERATIVE]: "roles.OPERATIVE_DESC",
  [chunkDSQZHRUF_cjs.PlatformRole.PLATFORM_ADMIN]: "roles.PLATFORM_ADMIN_DESC",
  [chunkDSQZHRUF_cjs.PlatformRole.PLATFORM_MODERATOR]: "roles.PLATFORM_MODERATOR_DESC",
  [chunkDSQZHRUF_cjs.PlatformRole.PLATFORM_SUPPORT]: "roles.PLATFORM_SUPPORT_DESC",
  [chunkDSQZHRUF_cjs.PlatformRole.PLATFORM_OPERATIVE]: "roles.PLATFORM_OPERATIVE_DESC"
};
var ROLE_BADGE_COLORS = {
  // Building roles
  [chunkDSQZHRUF_cjs.BuildingRole.OWNER_REPRESENTATIVE]: "info",
  [chunkDSQZHRUF_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: "success",
  [chunkDSQZHRUF_cjs.BuildingRole.CO_OWNER]: "warning",
  [chunkDSQZHRUF_cjs.BuildingRole.RESIDENT]: "neutral",
  // Org roles
  [chunkDSQZHRUF_cjs.OrgRole.ORG_ADMIN]: "purple",
  [chunkDSQZHRUF_cjs.OrgRole.SUPERVISOR]: "info",
  [chunkDSQZHRUF_cjs.OrgRole.REFERENT]: "success",
  [chunkDSQZHRUF_cjs.OrgRole.OPERATIVE]: "amber",
  // Platform roles
  [chunkDSQZHRUF_cjs.PlatformRole.PLATFORM_ADMIN]: "purple",
  [chunkDSQZHRUF_cjs.PlatformRole.PLATFORM_MODERATOR]: "info",
  [chunkDSQZHRUF_cjs.PlatformRole.PLATFORM_SUPPORT]: "success",
  [chunkDSQZHRUF_cjs.PlatformRole.PLATFORM_OPERATIVE]: "amber"
};
...
function isFeatureAvailable({
  ...
  const meta = chunkDSQZHRUF_cjs.PLATFORM_FEATURE_META[feature];
...
var parseApiError = (error) => {
  ...
  const code = chunkQE2L2C7M_cjs.isBackendErrorCode(rawCode) ? rawCode : null;
...
function canDoOnResource(subject, domain, action, resourceOwnerId) {
  const scopedPerms = chunkDSQZHRUF_cjs.SCOPED_PERMISSIONS[domain]?.[action];
...
function computeActionFlags(subject, domain, resourceOwnerId) {
  const approvePermission = chunkDSQZHRUF_cjs.APPROVE_PERMISSIONS[domain];
  return {
...
//# sourceMappingURL=chunk-OTLXDPRJ.cjs.map
//# sourceMappingURL=chunk-OTLXDPRJ.cjs.map