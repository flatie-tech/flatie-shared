...
var RELATED_TO_LINKABLE_TYPES = [
  chunkR7EQCGXX_cjs.LinkableEntityType.NOTICE,
  chunkR7EQCGXX_cjs.LinkableEntityType.EVENT,
  chunkR7EQCGXX_cjs.LinkableEntityType.POLL,
  chunkR7EQCGXX_cjs.LinkableEntityType.MAINTENANCE_LOG,
  chunkR7EQCGXX_cjs.LinkableEntityType.FAILURE_REPORT,
  chunkR7EQCGXX_cjs.LinkableEntityType.FILE,
  chunkR7EQCGXX_cjs.LinkableEntityType.BOARD_CARD
];
var ALLOWED_ENTITY_LINKS = [
  {
    source: chunkR7EQCGXX_cjs.LinkableEntityType.NOTICE,
    target: chunkR7EQCGXX_cjs.LinkableEntityType.EVENT,
    linkType: chunkR7EQCGXX_cjs.EntityLinkType.SCHEDULE
  },
  {
    source: chunkR7EQCGXX_cjs.LinkableEntityType.MAINTENANCE_LOG,
    target: chunkR7EQCGXX_cjs.LinkableEntityType.EVENT,
    linkType: chunkR7EQCGXX_cjs.EntityLinkType.SCHEDULE
  },
  {
    source: chunkR7EQCGXX_cjs.LinkableEntityType.FAILURE_REPORT,
    target: chunkR7EQCGXX_cjs.LinkableEntityType.EVENT,
    linkType: chunkR7EQCGXX_cjs.EntityLinkType.SCHEDULE
  },
  {
    source: chunkR7EQCGXX_cjs.LinkableEntityType.FAILURE_REPORT,
    target: chunkR7EQCGXX_cjs.LinkableEntityType.MAINTENANCE_LOG,
    linkType: chunkR7EQCGXX_cjs.EntityLinkType.RESOLVED_BY
  },
  {
    source: chunkR7EQCGXX_cjs.LinkableEntityType.MAINTENANCE_LOG,
    target: chunkR7EQCGXX_cjs.LinkableEntityType.POLL,
    linkType: chunkR7EQCGXX_cjs.EntityLinkType.BASED_ON
  },
  {
    source: chunkR7EQCGXX_cjs.LinkableEntityType.EXPENSE_TRANSACTION,
    target: chunkR7EQCGXX_cjs.LinkableEntityType.MAINTENANCE_LOG,
    linkType: chunkR7EQCGXX_cjs.EntityLinkType.EXPENSE_FOR
  },
  { source: "*", target: "*", linkType: chunkR7EQCGXX_cjs.EntityLinkType.RELATED_TO }
];
...
var ALL_READS = [
  ...chunkR7EQCGXX_cjs.domainPermissions("building", "read"),
  ...chunkR7EQCGXX_cjs.domainPermissions("user", "read"),
  ...chunkR7EQCGXX_cjs.domainPermissions("notice", "read"),
  ...chunkR7EQCGXX_cjs.domainPermissions("event", "read"),
  ...chunkR7EQCGXX_cjs.domainPermissions("poll", "read"),
  ...chunkR7EQCGXX_cjs.domainPermissions("failure_report", "read"),
  ...chunkR7EQCGXX_cjs.domainPermissions("maintenance_log", "read"),
  ...chunkR7EQCGXX_cjs.domainPermissions("financial", "read"),
  ...chunkR7EQCGXX_cjs.domainPermissions("document", "read"),
  ...chunkR7EQCGXX_cjs.domainPermissions("apartment", "read"),
  "house_rules:read",
  "faq:read",
  "board_card:read"
];
...
var CO_OWNER_PERMISSIONS = [
  ...ALL_READS,
  ...chunkR7EQCGXX_cjs.domainPermissions("notice", "own"),
  ...chunkR7EQCGXX_cjs.domainPermissions("event", "own"),
  ...chunkR7EQCGXX_cjs.domainPermissions("poll", "own"),
  "poll:vote",
  ...chunkR7EQCGXX_cjs.domainPermissions("failure_report", "own"),
  ...chunkR7EQCGXX_cjs.domainPermissions("document", "own"),
  "building_email:view",
  "vote:cast",
  "vote:weight_based",
  "user:delete:own"
...
var REPRESENTATIVE_PERMISSIONS = [
  ...
  ...chunkR7EQCGXX_cjs.domainPermissions("notice", "manage"),
  ...chunkR7EQCGXX_cjs.domainPermissions("event", "manage"),
  ...chunkR7EQCGXX_cjs.domainPermissions("poll", "manage"),
  ...chunkR7EQCGXX_cjs.domainPermissions("failure_report", "manage"),
  ...chunkR7EQCGXX_cjs.domainPermissions("document", "manage"),
  "notice:approve",
  "notice:pin",
...
var ORG_ADMIN_BUILDING_PERMISSIONS = [
  ...
  ...chunkR7EQCGXX_cjs.domainPermissions("maintenance_log", "manage"),
  "financial:create",
  "financial:update",
  "financial:delete",
  "apartment:create",
...
var BUILDING_ROLE_PERMISSIONS = {
  [chunkR7EQCGXX_cjs.BuildingRole.RESIDENT]: unique(RESIDENT_PERMISSIONS),
  [chunkR7EQCGXX_cjs.BuildingRole.CO_OWNER]: unique(CO_OWNER_PERMISSIONS),
  [chunkR7EQCGXX_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: unique(REPRESENTATIVE_PERMISSIONS),
  [chunkR7EQCGXX_cjs.BuildingRole.OWNER_REPRESENTATIVE]: unique(REPRESENTATIVE_PERMISSIONS)
};
var ORG_ROLE_PERMISSIONS = {
  [chunkR7EQCGXX_cjs.OrgRole.ORG_ADMIN]: unique([...ORG_ADMIN_BUILDING_PERMISSIONS, ...ORG_ADMIN_ORG_PERMISSIONS]),
  [chunkR7EQCGXX_cjs.OrgRole.SUPERVISOR]: unique([...SUPERVISOR_BUILDING_PERMISSIONS, ...SUPERVISOR_ORG_PERMISSIONS]),
  [chunkR7EQCGXX_cjs.OrgRole.REFERENT]: unique([...REFERENT_BUILDING_PERMISSIONS, ...REFERENT_ORG_PERMISSIONS]),
  [chunkR7EQCGXX_cjs.OrgRole.OPERATIVE]: unique([...OPERATIVE_BUILDING_PERMISSIONS, ...OPERATIVE_ORG_PERMISSIONS])
};
var PLATFORM_ROLE_PERMISSIONS = {
  [chunkR7EQCGXX_cjs.PlatformRole.PLATFORM_ADMIN]: [
  ...
  [chunkR7EQCGXX_cjs.PlatformRole.PLATFORM_MODERATOR]: [
    "platform:approve_buildings",
    "platform:manage_users",
    "platform:manage_orgs",
    "platform:view_orgs",
  ...
  [chunkR7EQCGXX_cjs.PlatformRole.PLATFORM_SUPPORT]: [
    "platform:approve_buildings",
    "platform:view_orgs",
    "platform:view_analytics",
    "platform:moderate_content"
  ],
  [chunkR7EQCGXX_cjs.PlatformRole.PLATFORM_OPERATIVE]: ["platform:view_analytics"]
};
var ALL_PERMISSIONS = unique(Object.values(chunkR7EQCGXX_cjs.Permission));
var ADMIN_ORG_PERMISSIONS = ORG_ROLE_PERMISSIONS[chunkR7EQCGXX_cjs.OrgRole.ORG_ADMIN];
var ADMIN_PLATFORM_PERMISSIONS = PLATFORM_ROLE_PERMISSIONS[chunkR7EQCGXX_cjs.PlatformRole.PLATFORM_ADMIN];
...
//# sourceMappingURL=chunk-656HMBRD.cjs.map
//# sourceMappingURL=chunk-656HMBRD.cjs.map