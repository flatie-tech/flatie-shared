...
var chunkFVDJCFES_cjs = require('./chunk-FVDJCFES.cjs');
...
var apartmentRoleSchema = zod.z.enum([chunkFVDJCFES_cjs.ApartmentRole.OWNER, chunkFVDJCFES_cjs.ApartmentRole.TENANT]).describe("`OWNER` for the title-deed holder, `TENANT` for a resident renting from the owner.");
...
var orgRoleSchema = zod.z.enum([chunkFVDJCFES_cjs.OrgRole.ORG_ADMIN, chunkFVDJCFES_cjs.OrgRole.SUPERVISOR, chunkFVDJCFES_cjs.OrgRole.REFERENT, chunkFVDJCFES_cjs.OrgRole.OPERATIVE]).describe(
...
var createOrganizationSchema = zod.z.object({
  ...
  type: zod.z.enum([chunkFVDJCFES_cjs.OrgType.MANAGEMENT_FIRM, chunkFVDJCFES_cjs.OrgType.PLATFORM]).describe(
...
var createBuildingSchema = zod.z.object({
  ...
  role: zod.z.enum([
    chunkFVDJCFES_cjs.BuildingRole.OWNER_REPRESENTATIVE,
    chunkFVDJCFES_cjs.BuildingRole.DEPUTY_REPRESENTATIVE,
    chunkFVDJCFES_cjs.BuildingRole.CO_OWNER
  ]).optional().describe(
...
function refineLocation(schema) {
  return schema.superRefine((data, ctx) => {
    if (data.locationType === chunkFVDJCFES_cjs.FailureLocationType.COMMON_AREA) {
    ...
    if (data.locationType === chunkFVDJCFES_cjs.FailureLocationType.OWN_UNIT) {
      if (!data.unitType) {
        ctx.addIssue({
          code: "custom",
...
var createFailureReportSchema = refineLocation(
  zod.z.object({
    ...
    priority: zod.z.enum([chunkFVDJCFES_cjs.Priority.NORMAL, chunkFVDJCFES_cjs.Priority.URGENT]).optional().describe("`normal` for standard reports, `urgent` to flag immediate attention."),
    locationType: zod.z.enum([chunkFVDJCFES_cjs.FailureLocationType.COMMON_AREA, chunkFVDJCFES_cjs.FailureLocationType.OWN_UNIT]).optional().describe(
    ...
    unitType: zod.z.enum([chunkFVDJCFES_cjs.FailureUnitType.APARTMENT, chunkFVDJCFES_cjs.FailureUnitType.GARAGE, chunkFVDJCFES_cjs.FailureUnitType.STORAGE_UNIT]).optional().describe("Kind of unit when `locationType` is `own_unit`. Required in that case."),
...
var updateFailureReportSchema = refineLocation(
  zod.z.object({
    ...
    priority: zod.z.enum([chunkFVDJCFES_cjs.Priority.NORMAL, chunkFVDJCFES_cjs.Priority.URGENT]).optional().describe("Revised priority: `normal` or `urgent`."),
    locationType: zod.z.enum([chunkFVDJCFES_cjs.FailureLocationType.COMMON_AREA, chunkFVDJCFES_cjs.FailureLocationType.OWN_UNIT]).optional().describe("Revised location classification: `common_area` or `own_unit`."),
    ...
    unitType: zod.z.enum([chunkFVDJCFES_cjs.FailureUnitType.APARTMENT, chunkFVDJCFES_cjs.FailureUnitType.GARAGE, chunkFVDJCFES_cjs.FailureUnitType.STORAGE_UNIT]).optional().describe("Revised unit kind. Required when `locationType` is `own_unit`."),
...
var createTransactionCategorySchema = zod.z.object({
  ...
  type: zod.z.enum([chunkFVDJCFES_cjs.TransactionType.INCOME, chunkFVDJCFES_cjs.TransactionType.EXPENSE]).describe(
...
var getTransactionCategoriesQuerySchema = zod.z.object({
  type: zod.z.enum([chunkFVDJCFES_cjs.TransactionType.INCOME, chunkFVDJCFES_cjs.TransactionType.EXPENSE]).optional().describe(
...
var roleTypeSchema = zod.z.enum([
  ...Object.values(chunkFVDJCFES_cjs.Role),
  ...Object.values(chunkFVDJCFES_cjs.BuildingRole),
  ...Object.values(chunkFVDJCFES_cjs.OrgRole),
  ...Object.values(chunkFVDJCFES_cjs.PlatformRole)
]);
...
var buildingStatusSchema = zod.z.enum(Object.values(chunkFVDJCFES_cjs.BuildingStatus)).describe(
...
var buildingDetailResponseSchema = zod.z.looseObject({
  ...
  createdAt: zod.z.string().describe("ISO-8601 timestamp when the building record was created."),
  updatedAt: zod.z.string().nullable().optional().describe("ISO-8601 timestamp of the last edit; null when never edited."),
  inboxAddress: zod.z.string().nullable().optional().describe(
...
({
  [chunkFVDJCFES_cjs.NotificationType.NOTICE_CREATED]: noticeCreatedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.NOTICE_APPROVED]: noticeApprovedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.NOTICE_REJECTED]: noticeRejectedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.POLL_CREATED]: pollCreatedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.POLL_DEADLINE_24H]: unimplementedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.POLL_DEADLINE_1H]: unimplementedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.POLL_FINALIZED]: pollFinalizedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.EVENT_CREATED]: eventCreatedOrUpdatedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.EVENT_UPDATED]: eventCreatedOrUpdatedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.EVENT_CANCELLED]: eventCancelledDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.EVENT_REMINDER_24H]: unimplementedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.EVENT_REMINDER_1H]: unimplementedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.WASTE_REMINDER_MIXED]: wasteReminderDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.WASTE_REMINDER_BIO]: wasteReminderDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.WASTE_REMINDER_PLASTIC_METAL]: wasteReminderDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.WASTE_REMINDER_PAPER_CARDBOARD]: wasteReminderDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.FAILURE_REPORT_CREATED]: failureReportCreatedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.FAILURE_REPORT_STATUS_CHANGED]: failureReportStatusDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.FAILURE_REPORT_RESOLVED]: failureReportStatusDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.MAINTENANCE_LOG_CREATED]: maintenanceLogCreatedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.PAYMENT_DUE]: unimplementedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.PAYMENT_RECEIVED]: unimplementedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.BUILDING_JOIN_REQUEST_RECEIVED]: buildingJoinRequestReceivedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.BUILDING_JOIN_REQUEST_APPROVED]: buildingJoinRequestDecidedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.BUILDING_JOIN_REQUEST_REJECTED]: buildingJoinRequestDecidedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.BUILDING_MEMBER_JOINED]: buildingMemberJoinedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.BUILDING_ROLE_CHANGED]: buildingRoleChangedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.BUILDING_PENDING_APPROVAL]: buildingPendingApprovalDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.BUILDING_APPROVED]: buildingApprovedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.BUILDING_REJECTED]: buildingRejectedDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.CHAT_MESSAGE]: chatMessageDataSchema,
  [chunkFVDJCFES_cjs.NotificationType.SYSTEM_ANNOUNCEMENT]: unimplementedDataSchema
});
...
var notificationTypeValues = Object.values(chunkFVDJCFES_cjs.NotificationType);
...
//# sourceMappingURL=chunk-QPT2WWVY.cjs.map
//# sourceMappingURL=chunk-QPT2WWVY.cjs.map