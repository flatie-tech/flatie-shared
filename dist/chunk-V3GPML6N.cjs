...
function canDoOnResource(ctx, domain, action, resourceOwnerId) {
  if (ctx.kind === "admin") return true;
  const scopedPerms = chunkMTL7OQUB_cjs.SCOPED_PERMISSIONS[domain]?.[action];
...
function computeActionFlags(ctx, domain, resourceOwnerId) {
  const approvePermission = chunkMTL7OQUB_cjs.APPROVE_PERMISSIONS[domain];
  return {
...
var ROLE_TRANSLATION_KEYS = {
  // Building roles
  [chunkMTL7OQUB_cjs.BuildingRole.OWNER_REPRESENTATIVE]: "roles.OWNER_REPRESENTATIVE",
  [chunkMTL7OQUB_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: "roles.DEPUTY_REPRESENTATIVE",
  [chunkMTL7OQUB_cjs.BuildingRole.CO_OWNER]: "roles.CO_OWNER",
  // Org roles
  [chunkMTL7OQUB_cjs.OrgRole.ORG_ADMIN]: "roles.ORG_ADMIN",
  [chunkMTL7OQUB_cjs.OrgRole.SUPERVISOR]: "roles.SUPERVISOR",
  [chunkMTL7OQUB_cjs.OrgRole.REFERENT]: "roles.REFERENT",
  [chunkMTL7OQUB_cjs.OrgRole.OPERATIVE]: "roles.OPERATIVE",
  // Platform roles
  [chunkMTL7OQUB_cjs.PlatformRole.PLATFORM_ADMIN]: "roles.PLATFORM_ADMIN",
  [chunkMTL7OQUB_cjs.PlatformRole.PLATFORM_MODERATOR]: "roles.PLATFORM_MODERATOR",
  [chunkMTL7OQUB_cjs.PlatformRole.PLATFORM_SUPPORT]: "roles.PLATFORM_SUPPORT",
  [chunkMTL7OQUB_cjs.PlatformRole.PLATFORM_OPERATIVE]: "roles.PLATFORM_OPERATIVE"
};
var ROLE_DESCRIPTION_KEYS = {
  [chunkMTL7OQUB_cjs.BuildingRole.OWNER_REPRESENTATIVE]: "roles.OWNER_REPRESENTATIVE_DESC",
  [chunkMTL7OQUB_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: "roles.DEPUTY_REPRESENTATIVE_DESC",
  [chunkMTL7OQUB_cjs.BuildingRole.CO_OWNER]: "roles.CO_OWNER_DESC",
  [chunkMTL7OQUB_cjs.OrgRole.ORG_ADMIN]: "roles.ORG_ADMIN_DESC",
  [chunkMTL7OQUB_cjs.OrgRole.SUPERVISOR]: "roles.SUPERVISOR_DESC",
  [chunkMTL7OQUB_cjs.OrgRole.REFERENT]: "roles.REFERENT_DESC",
  [chunkMTL7OQUB_cjs.OrgRole.OPERATIVE]: "roles.OPERATIVE_DESC",
  [chunkMTL7OQUB_cjs.PlatformRole.PLATFORM_ADMIN]: "roles.PLATFORM_ADMIN_DESC",
  [chunkMTL7OQUB_cjs.PlatformRole.PLATFORM_MODERATOR]: "roles.PLATFORM_MODERATOR_DESC",
  [chunkMTL7OQUB_cjs.PlatformRole.PLATFORM_SUPPORT]: "roles.PLATFORM_SUPPORT_DESC",
  [chunkMTL7OQUB_cjs.PlatformRole.PLATFORM_OPERATIVE]: "roles.PLATFORM_OPERATIVE_DESC"
};

// src/utils/status-variants.ts
function failureStatusVariant(status) {
  switch (status) {
    case chunkMTL7OQUB_cjs.FailureStatus.PENDING:
      return "info";
    case chunkMTL7OQUB_cjs.FailureStatus.IN_PROGRESS:
      return "warning";
    case chunkMTL7OQUB_cjs.FailureStatus.RESOLVED:
      return "success";
    default:
      return "neutral";
  }
...
function priorityVariant(priority) {
  switch (priority) {
    case chunkMTL7OQUB_cjs.Priority.URGENT:
      return "danger";
    case chunkMTL7OQUB_cjs.Priority.NORMAL:
      return "neutral";
    default:
      return "neutral";
  }
...
//# sourceMappingURL=chunk-V3GPML6N.cjs.map
//# sourceMappingURL=chunk-V3GPML6N.cjs.map