...
var RELATED_TO_LINKABLE_TYPES = [
  chunk4RUOR5YK_cjs.LinkableEntityType.NOTICE,
  chunk4RUOR5YK_cjs.LinkableEntityType.EVENT,
  chunk4RUOR5YK_cjs.LinkableEntityType.POLL,
  chunk4RUOR5YK_cjs.LinkableEntityType.MAINTENANCE_LOG,
  chunk4RUOR5YK_cjs.LinkableEntityType.FAILURE_REPORT,
  chunk4RUOR5YK_cjs.LinkableEntityType.FILE,
  chunk4RUOR5YK_cjs.LinkableEntityType.BOARD_CARD
];
var ALLOWED_ENTITY_LINKS = [
  {
    source: chunk4RUOR5YK_cjs.LinkableEntityType.NOTICE,
    target: chunk4RUOR5YK_cjs.LinkableEntityType.EVENT,
    linkType: chunk4RUOR5YK_cjs.EntityLinkType.SCHEDULE
  },
  {
    source: chunk4RUOR5YK_cjs.LinkableEntityType.MAINTENANCE_LOG,
    target: chunk4RUOR5YK_cjs.LinkableEntityType.EVENT,
    linkType: chunk4RUOR5YK_cjs.EntityLinkType.SCHEDULE
  },
  {
    source: chunk4RUOR5YK_cjs.LinkableEntityType.FAILURE_REPORT,
    target: chunk4RUOR5YK_cjs.LinkableEntityType.EVENT,
    linkType: chunk4RUOR5YK_cjs.EntityLinkType.SCHEDULE
  },
  {
    source: chunk4RUOR5YK_cjs.LinkableEntityType.FAILURE_REPORT,
    target: chunk4RUOR5YK_cjs.LinkableEntityType.MAINTENANCE_LOG,
    linkType: chunk4RUOR5YK_cjs.EntityLinkType.RESOLVED_BY
  },
  {
    source: chunk4RUOR5YK_cjs.LinkableEntityType.MAINTENANCE_LOG,
    target: chunk4RUOR5YK_cjs.LinkableEntityType.POLL,
    linkType: chunk4RUOR5YK_cjs.EntityLinkType.BASED_ON
  },
  {
    source: chunk4RUOR5YK_cjs.LinkableEntityType.EXPENSE_TRANSACTION,
    target: chunk4RUOR5YK_cjs.LinkableEntityType.MAINTENANCE_LOG,
    linkType: chunk4RUOR5YK_cjs.EntityLinkType.EXPENSE_FOR
  },
  { source: "*", target: "*", linkType: chunk4RUOR5YK_cjs.EntityLinkType.RELATED_TO }
];
...
var ALL_READS = [
  ...chunk4RUOR5YK_cjs.domainPermissions("building", "read"),
  ...chunk4RUOR5YK_cjs.domainPermissions("user", "read"),
  ...chunk4RUOR5YK_cjs.domainPermissions("notice", "read"),
  ...chunk4RUOR5YK_cjs.domainPermissions("event", "read"),
  ...chunk4RUOR5YK_cjs.domainPermissions("poll", "read"),
  ...chunk4RUOR5YK_cjs.domainPermissions("failure_report", "read"),
  ...chunk4RUOR5YK_cjs.domainPermissions("maintenance_log", "read"),
  ...chunk4RUOR5YK_cjs.domainPermissions("financial", "read"),
  ...chunk4RUOR5YK_cjs.domainPermissions("document", "read"),
  ...chunk4RUOR5YK_cjs.domainPermissions("apartment", "read"),
  "house_rules:read",
  "faq:read",
  "board_card:read"
];
...
var CO_OWNER_PERMISSIONS = [
  ...ALL_READS,
  ...chunk4RUOR5YK_cjs.domainPermissions("notice", "own"),
  ...chunk4RUOR5YK_cjs.domainPermissions("event", "own"),
  ...chunk4RUOR5YK_cjs.domainPermissions("poll", "own"),
  "poll:vote",
  ...chunk4RUOR5YK_cjs.domainPermissions("failure_report", "own"),
  ...chunk4RUOR5YK_cjs.domainPermissions("document", "own"),
  "building_email:view",
  "vote:cast",
  "vote:weight_based",
  "user:delete:own"
...
var REPRESENTATIVE_PERMISSIONS = [
  ...
  ...chunk4RUOR5YK_cjs.domainPermissions("notice", "manage"),
  ...chunk4RUOR5YK_cjs.domainPermissions("event", "manage"),
  ...chunk4RUOR5YK_cjs.domainPermissions("poll", "manage"),
  ...chunk4RUOR5YK_cjs.domainPermissions("failure_report", "manage"),
  ...chunk4RUOR5YK_cjs.domainPermissions("document", "manage"),
  "notice:approve",
  "notice:pin",
...
var ORG_ADMIN_BUILDING_PERMISSIONS = [
  ...
  ...chunk4RUOR5YK_cjs.domainPermissions("maintenance_log", "manage"),
  "financial:create",
  "financial:update",
  "financial:delete",
  "apartment:create",
...
var BUILDING_ROLE_PERMISSIONS = {
  [chunk4RUOR5YK_cjs.BuildingRole.RESIDENT]: unique(RESIDENT_PERMISSIONS),
  [chunk4RUOR5YK_cjs.BuildingRole.CO_OWNER]: unique(CO_OWNER_PERMISSIONS),
  [chunk4RUOR5YK_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: unique(REPRESENTATIVE_PERMISSIONS),
  [chunk4RUOR5YK_cjs.BuildingRole.OWNER_REPRESENTATIVE]: unique(REPRESENTATIVE_PERMISSIONS)
};
var ORG_ROLE_PERMISSIONS = {
  [chunk4RUOR5YK_cjs.OrgRole.ORG_ADMIN]: unique([...ORG_ADMIN_BUILDING_PERMISSIONS, ...ORG_ADMIN_ORG_PERMISSIONS]),
  [chunk4RUOR5YK_cjs.OrgRole.SUPERVISOR]: unique([...SUPERVISOR_BUILDING_PERMISSIONS, ...SUPERVISOR_ORG_PERMISSIONS]),
  [chunk4RUOR5YK_cjs.OrgRole.REFERENT]: unique([...REFERENT_BUILDING_PERMISSIONS, ...REFERENT_ORG_PERMISSIONS]),
  [chunk4RUOR5YK_cjs.OrgRole.OPERATIVE]: unique([...OPERATIVE_BUILDING_PERMISSIONS, ...OPERATIVE_ORG_PERMISSIONS])
};
var PLATFORM_ROLE_PERMISSIONS = {
  [chunk4RUOR5YK_cjs.PlatformRole.PLATFORM_ADMIN]: [
  ...
  [chunk4RUOR5YK_cjs.PlatformRole.PLATFORM_MODERATOR]: [
    "platform:approve_buildings",
    "platform:manage_users",
    "platform:manage_orgs",
    "platform:view_orgs",
  ...
  [chunk4RUOR5YK_cjs.PlatformRole.PLATFORM_SUPPORT]: [
    "platform:approve_buildings",
    "platform:view_orgs",
    "platform:view_analytics",
    "platform:moderate_content"
  ],
  [chunk4RUOR5YK_cjs.PlatformRole.PLATFORM_OPERATIVE]: ["platform:view_analytics"]
};
var ALL_PERMISSIONS = unique(Object.values(chunk4RUOR5YK_cjs.Permission));
var ADMIN_ORG_PERMISSIONS = ORG_ROLE_PERMISSIONS[chunk4RUOR5YK_cjs.OrgRole.ORG_ADMIN];
var ADMIN_PLATFORM_PERMISSIONS = PLATFORM_ROLE_PERMISSIONS[chunk4RUOR5YK_cjs.PlatformRole.PLATFORM_ADMIN];
...
//# sourceMappingURL=chunk-YGSYNZ43.cjs.map
//# sourceMappingURL=chunk-YGSYNZ43.cjs.map