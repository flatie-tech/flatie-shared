import { ApartmentRole, OrgRole, OrgType, BuildingRole, FailureUnitType, FailureLocationType, Priority, TransactionType, Role, PlatformRole, BuildingStatus, NotificationType } from './chunk-AYZLCXIL.js';
...
var buildingDetailResponseSchema = z.looseObject({
  ...
  createdAt: z.string().describe("ISO-8601 timestamp when the building record was created."),
  updatedAt: z.string().nullable().optional().describe("ISO-8601 timestamp of the last edit; null when never edited."),
  inboxAddress: z.string().nullable().optional().describe(
...
//# sourceMappingURL=chunk-BOTC6JXC.js.map
//# sourceMappingURL=chunk-BOTC6JXC.js.map