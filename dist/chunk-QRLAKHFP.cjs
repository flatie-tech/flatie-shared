...
var RELATED_TO_LINKABLE_TYPES = [
  chunkK6LAEP7U_cjs.LinkableEntityType.NOTICE,
  chunkK6LAEP7U_cjs.LinkableEntityType.EVENT,
  chunkK6LAEP7U_cjs.LinkableEntityType.POLL,
  chunkK6LAEP7U_cjs.LinkableEntityType.MAINTENANCE_LOG,
  chunkK6LAEP7U_cjs.LinkableEntityType.FAILURE_REPORT,
  chunkK6LAEP7U_cjs.LinkableEntityType.FILE,
  chunkK6LAEP7U_cjs.LinkableEntityType.BOARD_CARD
];
var ALLOWED_ENTITY_LINKS = [
  {
    source: chunkK6LAEP7U_cjs.LinkableEntityType.NOTICE,
    target: chunkK6LAEP7U_cjs.LinkableEntityType.EVENT,
    linkType: chunkK6LAEP7U_cjs.EntityLinkType.SCHEDULE
  },
  {
    source: chunkK6LAEP7U_cjs.LinkableEntityType.MAINTENANCE_LOG,
    target: chunkK6LAEP7U_cjs.LinkableEntityType.EVENT,
    linkType: chunkK6LAEP7U_cjs.EntityLinkType.SCHEDULE
  },
  {
    source: chunkK6LAEP7U_cjs.LinkableEntityType.FAILURE_REPORT,
    target: chunkK6LAEP7U_cjs.LinkableEntityType.EVENT,
    linkType: chunkK6LAEP7U_cjs.EntityLinkType.SCHEDULE
  },
  {
    source: chunkK6LAEP7U_cjs.LinkableEntityType.FAILURE_REPORT,
    target: chunkK6LAEP7U_cjs.LinkableEntityType.MAINTENANCE_LOG,
    linkType: chunkK6LAEP7U_cjs.EntityLinkType.RESOLVED_BY
  },
  {
    source: chunkK6LAEP7U_cjs.LinkableEntityType.MAINTENANCE_LOG,
    target: chunkK6LAEP7U_cjs.LinkableEntityType.POLL,
    linkType: chunkK6LAEP7U_cjs.EntityLinkType.BASED_ON
  },
  {
    source: chunkK6LAEP7U_cjs.LinkableEntityType.EXPENSE_TRANSACTION,
    target: chunkK6LAEP7U_cjs.LinkableEntityType.MAINTENANCE_LOG,
    linkType: chunkK6LAEP7U_cjs.EntityLinkType.EXPENSE_FOR
  },
  {
    source: chunkK6LAEP7U_cjs.LinkableEntityType.EXPENSE_TRANSACTION,
    target: chunkK6LAEP7U_cjs.LinkableEntityType.FAILURE_REPORT,
    linkType: chunkK6LAEP7U_cjs.EntityLinkType.EXPENSE_FOR
  },
  {
    source: chunkK6LAEP7U_cjs.LinkableEntityType.EXPENSE_TRANSACTION,
  ...
  { source: "*", target: "*", linkType: chunkK6LAEP7U_cjs.EntityLinkType.RELATED_TO }
];
...
var ALL_READS = [
  ...chunkK6LAEP7U_cjs.domainPermissions("building", "read"),
  ...chunkK6LAEP7U_cjs.domainPermissions("user", "read"),
  ...chunkK6LAEP7U_cjs.domainPermissions("notice", "read"),
  ...chunkK6LAEP7U_cjs.domainPermissions("event", "read"),
  ...chunkK6LAEP7U_cjs.domainPermissions("poll", "read"),
  ...chunkK6LAEP7U_cjs.domainPermissions("failure_report", "read"),
  ...chunkK6LAEP7U_cjs.domainPermissions("maintenance_log", "read"),
  ...chunkK6LAEP7U_cjs.domainPermissions("financial", "read"),
  ...chunkK6LAEP7U_cjs.domainPermissions("document", "read"),
  ...chunkK6LAEP7U_cjs.domainPermissions("unit", "read"),
  ...chunkK6LAEP7U_cjs.domainPermissions("apartment", "read"),
...
var RESIDENT_PERMISSIONS = [
  ...
  ...chunkK6LAEP7U_cjs.domainPermissions("notice", "own"),
  ...chunkK6LAEP7U_cjs.domainPermissions("event", "own"),
  ...chunkK6LAEP7U_cjs.domainPermissions("poll", "own"),
  "poll:vote",
  ...chunkK6LAEP7U_cjs.domainPermissions("failure_report", "own"),
  ...chunkK6LAEP7U_cjs.domainPermissions("document", "own"),
  "user:delete:own"
];
...
var REPRESENTATIVE_PERMISSIONS = [
  ...
  ...chunkK6LAEP7U_cjs.domainPermissions("notice", "manage"),
  ...chunkK6LAEP7U_cjs.domainPermissions("event", "manage"),
  ...chunkK6LAEP7U_cjs.domainPermissions("poll", "manage"),
  ...chunkK6LAEP7U_cjs.domainPermissions("failure_report", "manage"),
  ...chunkK6LAEP7U_cjs.domainPermissions("document", "manage"),
  "notice:approve",
  "notice:pin",
  ...
  "financial:update",
  "financial:delete",
  ...chunkK6LAEP7U_cjs.domainPermissions("maintenance_log", "manage"),
...
var BUILDING_ROLE_PERMISSIONS = {
  [chunkK6LAEP7U_cjs.BuildingRole.RESIDENT]: unique(RESIDENT_PERMISSIONS),
  [chunkK6LAEP7U_cjs.BuildingRole.CO_OWNER]: unique(CO_OWNER_PERMISSIONS),
  [chunkK6LAEP7U_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: unique(REPRESENTATIVE_PERMISSIONS),
  [chunkK6LAEP7U_cjs.BuildingRole.OWNER_REPRESENTATIVE]: unique(REPRESENTATIVE_PERMISSIONS)
};
var ORG_ROLE_PERMISSIONS = {
  [chunkK6LAEP7U_cjs.OrgRole.ORG_ADMIN]: unique([...ORG_ADMIN_BUILDING_PERMISSIONS, ...ORG_ADMIN_ORG_PERMISSIONS]),
  [chunkK6LAEP7U_cjs.OrgRole.SUPERVISOR]: unique([...SUPERVISOR_BUILDING_PERMISSIONS, ...SUPERVISOR_ORG_PERMISSIONS]),
  [chunkK6LAEP7U_cjs.OrgRole.REFERENT]: unique([...REFERENT_BUILDING_PERMISSIONS, ...REFERENT_ORG_PERMISSIONS]),
  [chunkK6LAEP7U_cjs.OrgRole.OPERATIVE]: unique([...OPERATIVE_BUILDING_PERMISSIONS, ...OPERATIVE_ORG_PERMISSIONS])
};
var PLATFORM_ROLE_PERMISSIONS = {
  [chunkK6LAEP7U_cjs.PlatformRole.PLATFORM_ADMIN]: [
  ...
  [chunkK6LAEP7U_cjs.PlatformRole.PLATFORM_MODERATOR]: [
    "platform:approve_buildings",
    "platform:manage_users",
    "platform:manage_orgs",
    "platform:view_orgs",
  ...
  [chunkK6LAEP7U_cjs.PlatformRole.PLATFORM_SUPPORT]: [
    "platform:approve_buildings",
    "platform:view_orgs",
    "platform:view_analytics",
    "platform:moderate_content"
  ],
  [chunkK6LAEP7U_cjs.PlatformRole.PLATFORM_OPERATIVE]: ["platform:view_analytics"]
};
var ALL_PERMISSIONS = unique(Object.values(chunkK6LAEP7U_cjs.Permission));
var ADMIN_ORG_PERMISSIONS = ORG_ROLE_PERMISSIONS[chunkK6LAEP7U_cjs.OrgRole.ORG_ADMIN];
var ADMIN_PLATFORM_PERMISSIONS = PLATFORM_ROLE_PERMISSIONS[chunkK6LAEP7U_cjs.PlatformRole.PLATFORM_ADMIN];
...
//# sourceMappingURL=chunk-QRLAKHFP.cjs.map
//# sourceMappingURL=chunk-QRLAKHFP.cjs.map