...
var apartmentRoleSchema = zod.z.enum([chunkQTV2ZV2E_cjs.ApartmentRole.OWNER, chunkQTV2ZV2E_cjs.ApartmentRole.TENANT]).describe("`OWNER` for the title-deed holder, `TENANT` for a resident renting from the owner.");
...
var orgRoleSchema = zod.z.enum([chunkQTV2ZV2E_cjs.OrgRole.ORG_ADMIN, chunkQTV2ZV2E_cjs.OrgRole.SUPERVISOR, chunkQTV2ZV2E_cjs.OrgRole.REFERENT, chunkQTV2ZV2E_cjs.OrgRole.OPERATIVE]).describe(
...
var createOrganizationSchema = zod.z.object({
  ...
  type: zod.z.enum([chunkQTV2ZV2E_cjs.OrgType.MANAGEMENT_FIRM, chunkQTV2ZV2E_cjs.OrgType.PLATFORM]).describe(
...
var createBuildingSchema = zod.z.object({
  ...
  role: zod.z.enum([
    ...
    chunkQTV2ZV2E_cjs.BuildingRole.CO_OWNER
  ]).optional().describe(
...
var buildingQuotaEntrySchema = zod.z.object({
  resourceType: zod.z.enum(
    chunkQTV2ZV2E_cjs.QUOTA_RESOURCE_TYPES
  ),
  dailyLimit: zod.z.number().int().min(0).max(1e4).nullable()
});
var buildingQuotaConfigSchema = zod.z.object({
  quotas: zod.z.array(buildingQuotaEntrySchema).max(chunkQTV2ZV2E_cjs.QUOTA_RESOURCE_TYPES.length)
});
...
function refineLocation(schema) {
  return schema.superRefine((data, ctx) => {
    if (data.locationType === chunkQTV2ZV2E_cjs.FailureLocationType.COMMON_AREA) {
    ...
    if (data.locationType === chunkQTV2ZV2E_cjs.FailureLocationType.OWN_UNIT) {
      if (!data.unitType) {
        ctx.addIssue({
          code: "custom",
...
var createFailureReportSchema = refineLocation(
  zod.z.object({
    ...
    priority: zod.z.enum([chunkQTV2ZV2E_cjs.Priority.NORMAL, chunkQTV2ZV2E_cjs.Priority.URGENT]).optional().describe("`normal` for standard reports, `urgent` to flag immediate attention."),
    locationType: zod.z.enum([chunkQTV2ZV2E_cjs.FailureLocationType.COMMON_AREA, chunkQTV2ZV2E_cjs.FailureLocationType.OWN_UNIT]).optional().describe(
    ...
    unitType: zod.z.enum([chunkQTV2ZV2E_cjs.FailureUnitType.APARTMENT, chunkQTV2ZV2E_cjs.FailureUnitType.GARAGE, chunkQTV2ZV2E_cjs.FailureUnitType.STORAGE_UNIT]).optional().describe("Kind of unit when `locationType` is `own_unit`. Required in that case."),
...
var updateFailureReportSchema = refineLocation(
  zod.z.object({
    ...
    priority: zod.z.enum([chunkQTV2ZV2E_cjs.Priority.NORMAL, chunkQTV2ZV2E_cjs.Priority.URGENT]).optional().describe("Revised priority: `normal` or `urgent`."),
    locationType: zod.z.enum([chunkQTV2ZV2E_cjs.FailureLocationType.COMMON_AREA, chunkQTV2ZV2E_cjs.FailureLocationType.OWN_UNIT]).optional().describe("Revised location classification: `common_area` or `own_unit`."),
    ...
    unitType: zod.z.enum([chunkQTV2ZV2E_cjs.FailureUnitType.APARTMENT, chunkQTV2ZV2E_cjs.FailureUnitType.GARAGE, chunkQTV2ZV2E_cjs.FailureUnitType.STORAGE_UNIT]).optional().describe("Revised unit kind. Required when `locationType` is `own_unit`."),
...
var createTransactionCategorySchema = zod.z.object({
  ...
  type: zod.z.enum([chunkQTV2ZV2E_cjs.TransactionType.INCOME, chunkQTV2ZV2E_cjs.TransactionType.EXPENSE]).describe(
...
var getTransactionCategoriesQuerySchema = zod.z.object({
  type: zod.z.enum([chunkQTV2ZV2E_cjs.TransactionType.INCOME, chunkQTV2ZV2E_cjs.TransactionType.EXPENSE]).optional().describe(
...
var roleTypeSchema = zod.z.enum([
  ...Object.values(chunkQTV2ZV2E_cjs.BuildingRole),
  ...Object.values(chunkQTV2ZV2E_cjs.OrgRole),
  ...Object.values(chunkQTV2ZV2E_cjs.PlatformRole)
]);
...
var buildingStatusSchema = zod.z.enum(Object.values(chunkQTV2ZV2E_cjs.BuildingStatus)).describe(
...
({
  [chunkQTV2ZV2E_cjs.NotificationType.NOTICE_CREATED]: noticeCreatedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.NOTICE_APPROVED]: noticeApprovedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.NOTICE_REJECTED]: noticeRejectedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.POLL_CREATED]: pollCreatedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.POLL_DEADLINE_24H]: unimplementedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.POLL_DEADLINE_1H]: unimplementedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.POLL_FINALIZED]: pollFinalizedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.EVENT_CREATED]: eventCreatedOrUpdatedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.EVENT_UPDATED]: eventCreatedOrUpdatedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.EVENT_CANCELLED]: eventCancelledDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.EVENT_REMINDER_24H]: unimplementedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.EVENT_REMINDER_1H]: unimplementedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.WASTE_REMINDER_MIXED]: wasteReminderDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.WASTE_REMINDER_BIO]: wasteReminderDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.WASTE_REMINDER_PLASTIC_METAL]: wasteReminderDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.WASTE_REMINDER_PAPER_CARDBOARD]: wasteReminderDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.FAILURE_REPORT_CREATED]: failureReportCreatedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.FAILURE_REPORT_STATUS_CHANGED]: failureReportStatusDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.FAILURE_REPORT_RESOLVED]: failureReportStatusDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.MAINTENANCE_LOG_CREATED]: maintenanceLogCreatedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.PAYMENT_DUE]: unimplementedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.PAYMENT_RECEIVED]: unimplementedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.BUILDING_JOIN_REQUEST_RECEIVED]: buildingJoinRequestReceivedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.BUILDING_JOIN_REQUEST_APPROVED]: buildingJoinRequestDecidedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.BUILDING_JOIN_REQUEST_REJECTED]: buildingJoinRequestDecidedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.BUILDING_MEMBER_JOINED]: buildingMemberJoinedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.BUILDING_ROLE_CHANGED]: buildingRoleChangedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.BUILDING_PENDING_APPROVAL]: buildingPendingApprovalDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.BUILDING_APPROVED]: buildingApprovedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.BUILDING_REJECTED]: buildingRejectedDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.CHAT_MESSAGE]: chatMessageDataSchema,
  [chunkQTV2ZV2E_cjs.NotificationType.SYSTEM_ANNOUNCEMENT]: unimplementedDataSchema
});
...
var notificationTypeValues = Object.values(chunkQTV2ZV2E_cjs.NotificationType);
...
//# sourceMappingURL=chunk-L65IQBFZ.cjs.map
//# sourceMappingURL=chunk-L65IQBFZ.cjs.map