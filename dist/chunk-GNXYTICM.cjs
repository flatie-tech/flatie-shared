...
var pricuvaKeys = {
  all: ["pricuva"],
  me: (buildingId) => [...pricuvaKeys.all, "me", buildingId],
  deliveries: (buildingId, period) => [...pricuvaKeys.all, "deliveries", buildingId, period],
  openingBalances: (buildingId) => [...pricuvaKeys.all, "opening-balances", buildingId],
  unmatchedRefs: (buildingId) => [...pricuvaKeys.all, "unmatched-refs", buildingId]
};
var dunningKeys = {
  all: ["dunning"],
  building: (buildingId) => [...dunningKeys.all, buildingId],
  candidates: (buildingId, asOf) => [...dunningKeys.building(buildingId), "candidates", asOf ?? "today"],
  cases: (buildingId, filters = {}) => [...dunningKeys.building(buildingId), "cases", { ...filters }],
...
exports.dunningKeys = dunningKeys;
...
exports.pricuvaKeys = pricuvaKeys;
