...
var apartmentRoleSchema = zod.z.enum([chunk4RUOR5YK_cjs.ApartmentRole.OWNER, chunk4RUOR5YK_cjs.ApartmentRole.TENANT]).describe("`OWNER` for the title-deed holder, `TENANT` for a resident renting from the owner.");
...
var boardVisibilitySchema = zod.z.enum([chunk4RUOR5YK_cjs.BoardVisibility.BUILDING, chunk4RUOR5YK_cjs.BoardVisibility.REPRESENTATIVES]);
...
var prioritySchema = zod.z.enum([chunk4RUOR5YK_cjs.Priority.NORMAL, chunk4RUOR5YK_cjs.Priority.URGENT]);
...
var orgRoleSchema = zod.z.enum([chunk4RUOR5YK_cjs.OrgRole.ORG_ADMIN, chunk4RUOR5YK_cjs.OrgRole.SUPERVISOR, chunk4RUOR5YK_cjs.OrgRole.REFERENT, chunk4RUOR5YK_cjs.OrgRole.OPERATIVE]).describe(
...
var createOrganizationSchema = zod.z.object({
  ...
  type: zod.z.enum([chunk4RUOR5YK_cjs.OrgType.MANAGEMENT_FIRM, chunk4RUOR5YK_cjs.OrgType.PLATFORM]).describe(
...
var BUILDING_TYPES = [
  chunk4RUOR5YK_cjs.BuildingType.RESIDENTIAL,
  chunk4RUOR5YK_cjs.BuildingType.COMMERCIAL,
  chunk4RUOR5YK_cjs.BuildingType.RESIDENTIAL_COMMERCIAL
];
...
var createBuildingSchema = zod.z.object({
  ...
  role: zod.z.enum([
    ...
    chunk4RUOR5YK_cjs.BuildingRole.CO_OWNER
  ]).optional().describe(
...
var updateBuildingSchema = zod.z.object({
  ...
  fundsSource: zod.z.enum([chunk4RUOR5YK_cjs.FundsSource.MANUAL, chunk4RUOR5YK_cjs.FundsSource.CAMT]).optional().describe(
  ...
  pricuvaRefMode: zod.z.enum([chunk4RUOR5YK_cjs.PricuvaRefMode.APARTMENT, chunk4RUOR5YK_cjs.PricuvaRefMode.OWNER]).optional().describe(
...
var buildingQuotaEntrySchema = zod.z.object({
  resourceType: zod.z.enum(
    chunk4RUOR5YK_cjs.QUOTA_RESOURCE_TYPES
  ),
  dailyLimit: zod.z.number().int().min(0).max(1e4).nullable()
});
var buildingQuotaConfigSchema = zod.z.object({
  quotas: zod.z.array(buildingQuotaEntrySchema).max(chunk4RUOR5YK_cjs.QUOTA_RESOURCE_TYPES.length)
});
...
function refineLocation(schema) {
  return schema.superRefine((data, ctx) => {
    if (data.locationType === chunk4RUOR5YK_cjs.FailureLocationType.COMMON_AREA) {
    ...
    if (data.locationType === chunk4RUOR5YK_cjs.FailureLocationType.OWN_UNIT) {
      if (!data.unitType) {
        ctx.addIssue({
          code: "custom",
...
var createFailureReportSchema = refineLocation(
  zod.z.object({
    ...
    priority: zod.z.enum([chunk4RUOR5YK_cjs.Priority.NORMAL, chunk4RUOR5YK_cjs.Priority.URGENT]).optional().describe("`normal` for standard reports, `urgent` to flag immediate attention."),
    locationType: zod.z.enum([chunk4RUOR5YK_cjs.FailureLocationType.COMMON_AREA, chunk4RUOR5YK_cjs.FailureLocationType.OWN_UNIT]).optional().describe(
    ...
    unitType: zod.z.enum([chunk4RUOR5YK_cjs.FailureUnitType.APARTMENT, chunk4RUOR5YK_cjs.FailureUnitType.GARAGE, chunk4RUOR5YK_cjs.FailureUnitType.STORAGE_UNIT]).optional().describe("Kind of unit when `locationType` is `own_unit`. Required in that case."),
...
var updateFailureReportSchema = refineLocation(
  zod.z.object({
    ...
    status: zod.z.enum([chunk4RUOR5YK_cjs.FailureStatus.PENDING, chunk4RUOR5YK_cjs.FailureStatus.IN_PROGRESS, chunk4RUOR5YK_cjs.FailureStatus.RESOLVED]).optional().describe(
      "Lifecycle status: `pending` (newly filed), `in_progress` (assigned work), `resolved` (closed out)."
    ),
    priority: zod.z.enum([chunk4RUOR5YK_cjs.Priority.NORMAL, chunk4RUOR5YK_cjs.Priority.URGENT]).optional().describe("Revised priority: `normal` or `urgent`."),
    locationType: zod.z.enum([chunk4RUOR5YK_cjs.FailureLocationType.COMMON_AREA, chunk4RUOR5YK_cjs.FailureLocationType.OWN_UNIT]).optional().describe("Revised location classification: `common_area` or `own_unit`."),
    ...
    unitType: zod.z.enum([chunk4RUOR5YK_cjs.FailureUnitType.APARTMENT, chunk4RUOR5YK_cjs.FailureUnitType.GARAGE, chunk4RUOR5YK_cjs.FailureUnitType.STORAGE_UNIT]).optional().describe("Revised unit kind. Required when `locationType` is `own_unit`."),
...
var garageRoleSchema = zod.z.enum([chunk4RUOR5YK_cjs.ApartmentRole.OWNER, chunk4RUOR5YK_cjs.ApartmentRole.TENANT]).describe("`owner` for the title-deed holder, `tenant` for a resident renting from the owner.");
...
var orgQuotaEntrySchema = zod.z.object({
  resourceType: zod.z.enum(
    chunk4RUOR5YK_cjs.ORG_QUOTA_RESOURCE_TYPES
  ),
  dailyLimit: zod.z.number().int().min(0).max(1e4).nullable()
});
var orgQuotaConfigSchema = zod.z.object({
  quotas: zod.z.array(orgQuotaEntrySchema).max(chunk4RUOR5YK_cjs.ORG_QUOTA_RESOURCE_TYPES.length)
});
...
var POLL_TYPES = [chunk4RUOR5YK_cjs.PollType.CONSENSUS, chunk4RUOR5YK_cjs.PollType.COMMUNITY];
...
var storageUnitRoleSchema = zod.z.enum([chunk4RUOR5YK_cjs.ApartmentRole.OWNER, chunk4RUOR5YK_cjs.ApartmentRole.TENANT]).describe("`owner` for the title-deed holder, `tenant` for a resident renting from the owner.");
...
var createTransactionCategorySchema = zod.z.object({
  ...
  type: zod.z.enum([chunk4RUOR5YK_cjs.TransactionType.INCOME, chunk4RUOR5YK_cjs.TransactionType.EXPENSE]).describe(
...
var getTransactionCategoriesQuerySchema = zod.z.object({
  type: zod.z.enum([chunk4RUOR5YK_cjs.TransactionType.INCOME, chunk4RUOR5YK_cjs.TransactionType.EXPENSE]).optional().describe(
...
var roleTypeSchema = zod.z.enum([
  ...Object.values(chunk4RUOR5YK_cjs.BuildingRole),
  ...Object.values(chunk4RUOR5YK_cjs.OrgRole),
  ...Object.values(chunk4RUOR5YK_cjs.PlatformRole)
]);
...
var getRepBuildingsParamsSchema = zod.z.object({
  ...
  type: zod.z.enum([chunk4RUOR5YK_cjs.BuildingType.RESIDENTIAL, chunk4RUOR5YK_cjs.BuildingType.COMMERCIAL, chunk4RUOR5YK_cjs.BuildingType.RESIDENTIAL_COMMERCIAL]).optional().describe("Restrict to a single building usage type."),
...
var buildingStatusSchema = zod.z.enum(Object.values(chunk4RUOR5YK_cjs.BuildingStatus)).describe(
...
var commonStatusOptions = [
  chunk4RUOR5YK_cjs.CommonStatus.ACTIVE,
  chunk4RUOR5YK_cjs.CommonStatus.COMPLETED,
  chunk4RUOR5YK_cjs.CommonStatus.CANCELLED
];
var approvalStatusOptions = [
  chunk4RUOR5YK_cjs.ApprovalStatus.PENDING,
  chunk4RUOR5YK_cjs.ApprovalStatus.APPROVED,
  chunk4RUOR5YK_cjs.ApprovalStatus.REJECTED
];
var maintenanceStatusOptions = [
  chunk4RUOR5YK_cjs.MaintenanceStatus.PENDING,
  chunk4RUOR5YK_cjs.MaintenanceStatus.IN_PROGRESS,
  chunk4RUOR5YK_cjs.MaintenanceStatus.COMPLETED,
  chunk4RUOR5YK_cjs.MaintenanceStatus.CANCELLED
];
var failureStatusOptions = [
  chunk4RUOR5YK_cjs.FailureStatus.PENDING,
  chunk4RUOR5YK_cjs.FailureStatus.IN_PROGRESS,
  chunk4RUOR5YK_cjs.FailureStatus.RESOLVED
];
...
({
  [chunk4RUOR5YK_cjs.NotificationType.NOTICE_CREATED]: noticeCreatedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.NOTICE_APPROVED]: noticeApprovedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.NOTICE_REJECTED]: noticeRejectedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.POLL_CREATED]: pollCreatedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.POLL_DEADLINE_24H]: unimplementedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.POLL_DEADLINE_1H]: unimplementedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.POLL_FINALIZED]: pollFinalizedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.EVENT_CREATED]: eventCreatedOrUpdatedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.EVENT_UPDATED]: eventCreatedOrUpdatedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.EVENT_CANCELLED]: eventCancelledDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.EVENT_REMINDER_24H]: eventReminderDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.EVENT_REMINDER_1H]: eventReminderDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.WASTE_REMINDER_MIXED]: wasteReminderDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.WASTE_REMINDER_BIO]: wasteReminderDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.WASTE_REMINDER_PLASTIC_METAL]: wasteReminderDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.WASTE_REMINDER_PAPER_CARDBOARD]: wasteReminderDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.FAILURE_REPORT_CREATED]: failureReportCreatedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.FAILURE_REPORT_STATUS_CHANGED]: failureReportStatusDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.FAILURE_REPORT_RESOLVED]: failureReportStatusDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.MAINTENANCE_LOG_CREATED]: maintenanceLogCreatedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.PAYMENT_DUE]: unimplementedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.PAYMENT_RECEIVED]: unimplementedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.BUILDING_JOIN_REQUEST_RECEIVED]: buildingJoinRequestReceivedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.BUILDING_JOIN_REQUEST_APPROVED]: buildingJoinRequestDecidedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.BUILDING_JOIN_REQUEST_REJECTED]: buildingJoinRequestDecidedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.BUILDING_MEMBER_JOINED]: buildingMemberJoinedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.BUILDING_ROLE_CHANGED]: buildingRoleChangedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.BUILDING_PENDING_APPROVAL]: buildingPendingApprovalDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.BUILDING_APPROVED]: buildingApprovedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.BUILDING_REJECTED]: buildingRejectedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.CHAT_MESSAGE]: chatMessageDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.POLL_VOTE_SIGNATURE_PENDING]: pollVoteSignatureDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.POLL_VOTE_SIGNATURE_APPROVED]: pollVoteSignatureDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.POLL_VOTE_SIGNATURE_REJECTED]: pollVoteSignatureRejectedDataSchema,
  [chunk4RUOR5YK_cjs.NotificationType.SYSTEM_ANNOUNCEMENT]: unimplementedDataSchema
});
...
var notificationTypeValues = Object.values(chunk4RUOR5YK_cjs.NotificationType);
...
var pollResultsSchema = zod.z.looseObject({
  ...
  cannotVoteReason: zod.z.enum(Object.values(chunk4RUOR5YK_cjs.PollCannotVoteReason)).optional().describe("Machine-readable reason the caller cannot vote (present when canVote is false)."),
...
var repUserRoleSchema = zod.z.enum([
  ...
  chunk4RUOR5YK_cjs.BuildingRole.DEPUTY_REPRESENTATIVE,
  chunk4RUOR5YK_cjs.BuildingRole.CO_OWNER,
  chunk4RUOR5YK_cjs.BuildingRole.RESIDENT
...
//# sourceMappingURL=chunk-VB5V7AOF.cjs.map
//# sourceMappingURL=chunk-VB5V7AOF.cjs.map