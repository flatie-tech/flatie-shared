...
var ROLE_TRANSLATION_KEYS = {
  // Building roles
  [chunkN53GQVG7_cjs.BuildingRole.OWNER_REPRESENTATIVE]: "roles.OWNER_REPRESENTATIVE",
  [chunkN53GQVG7_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: "roles.DEPUTY_REPRESENTATIVE",
  [chunkN53GQVG7_cjs.BuildingRole.CO_OWNER]: "roles.CO_OWNER",
  [chunkN53GQVG7_cjs.BuildingRole.RESIDENT]: "roles.RESIDENT",
  // Org roles
  [chunkN53GQVG7_cjs.OrgRole.ORG_ADMIN]: "roles.ORG_ADMIN",
  [chunkN53GQVG7_cjs.OrgRole.SUPERVISOR]: "roles.SUPERVISOR",
  [chunkN53GQVG7_cjs.OrgRole.REFERENT]: "roles.REFERENT",
  [chunkN53GQVG7_cjs.OrgRole.OPERATIVE]: "roles.OPERATIVE",
  // Platform roles
  [chunkN53GQVG7_cjs.PlatformRole.PLATFORM_ADMIN]: "roles.PLATFORM_ADMIN",
  [chunkN53GQVG7_cjs.PlatformRole.PLATFORM_MODERATOR]: "roles.PLATFORM_MODERATOR",
  [chunkN53GQVG7_cjs.PlatformRole.PLATFORM_SUPPORT]: "roles.PLATFORM_SUPPORT",
  [chunkN53GQVG7_cjs.PlatformRole.PLATFORM_OPERATIVE]: "roles.PLATFORM_OPERATIVE"
};
var ROLE_DESCRIPTION_KEYS = {
  [chunkN53GQVG7_cjs.BuildingRole.OWNER_REPRESENTATIVE]: "roles.OWNER_REPRESENTATIVE_DESC",
  [chunkN53GQVG7_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: "roles.DEPUTY_REPRESENTATIVE_DESC",
  [chunkN53GQVG7_cjs.BuildingRole.CO_OWNER]: "roles.CO_OWNER_DESC",
  [chunkN53GQVG7_cjs.BuildingRole.RESIDENT]: "roles.RESIDENT_DESC",
  [chunkN53GQVG7_cjs.OrgRole.ORG_ADMIN]: "roles.ORG_ADMIN_DESC",
  [chunkN53GQVG7_cjs.OrgRole.SUPERVISOR]: "roles.SUPERVISOR_DESC",
  [chunkN53GQVG7_cjs.OrgRole.REFERENT]: "roles.REFERENT_DESC",
  [chunkN53GQVG7_cjs.OrgRole.OPERATIVE]: "roles.OPERATIVE_DESC",
  [chunkN53GQVG7_cjs.PlatformRole.PLATFORM_ADMIN]: "roles.PLATFORM_ADMIN_DESC",
  [chunkN53GQVG7_cjs.PlatformRole.PLATFORM_MODERATOR]: "roles.PLATFORM_MODERATOR_DESC",
  [chunkN53GQVG7_cjs.PlatformRole.PLATFORM_SUPPORT]: "roles.PLATFORM_SUPPORT_DESC",
  [chunkN53GQVG7_cjs.PlatformRole.PLATFORM_OPERATIVE]: "roles.PLATFORM_OPERATIVE_DESC"
};
var ROLE_BADGE_COLORS = {
  // Building roles
  [chunkN53GQVG7_cjs.BuildingRole.OWNER_REPRESENTATIVE]: "info",
  [chunkN53GQVG7_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: "success",
  [chunkN53GQVG7_cjs.BuildingRole.CO_OWNER]: "warning",
  [chunkN53GQVG7_cjs.BuildingRole.RESIDENT]: "neutral",
  // Org roles
  [chunkN53GQVG7_cjs.OrgRole.ORG_ADMIN]: "purple",
  [chunkN53GQVG7_cjs.OrgRole.SUPERVISOR]: "info",
  [chunkN53GQVG7_cjs.OrgRole.REFERENT]: "success",
  [chunkN53GQVG7_cjs.OrgRole.OPERATIVE]: "amber",
  // Platform roles
  [chunkN53GQVG7_cjs.PlatformRole.PLATFORM_ADMIN]: "purple",
  [chunkN53GQVG7_cjs.PlatformRole.PLATFORM_MODERATOR]: "info",
  [chunkN53GQVG7_cjs.PlatformRole.PLATFORM_SUPPORT]: "success",
  [chunkN53GQVG7_cjs.PlatformRole.PLATFORM_OPERATIVE]: "amber"
};
...
function isFeatureAvailable({
  ...
  const meta = chunkN53GQVG7_cjs.PLATFORM_FEATURE_META[feature];
...
var parseApiError = (error) => {
  ...
  const code = chunkUF3JI7WZ_cjs.isBackendErrorCode(rawCode) ? rawCode : null;
...
function canDoOnResource(subject, domain, action, resourceOwnerId) {
  const scopedPerms = chunkN53GQVG7_cjs.SCOPED_PERMISSIONS[domain]?.[action];
...
function computeActionFlags(subject, domain, resourceOwnerId) {
  const approvePermission = chunkN53GQVG7_cjs.APPROVE_PERMISSIONS[domain];
  return {
...
//# sourceMappingURL=chunk-IYK3SBQT.cjs.map
//# sourceMappingURL=chunk-IYK3SBQT.cjs.map