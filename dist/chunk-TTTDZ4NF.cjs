...
var RELATED_TO_LINKABLE_TYPES = [
  chunkSCHBLK77_cjs.LinkableEntityType.NOTICE,
  chunkSCHBLK77_cjs.LinkableEntityType.EVENT,
  chunkSCHBLK77_cjs.LinkableEntityType.POLL,
  chunkSCHBLK77_cjs.LinkableEntityType.MAINTENANCE_LOG,
  chunkSCHBLK77_cjs.LinkableEntityType.FAILURE_REPORT,
  chunkSCHBLK77_cjs.LinkableEntityType.FILE,
  chunkSCHBLK77_cjs.LinkableEntityType.BOARD_CARD
];
var ALLOWED_ENTITY_LINKS = [
  {
    source: chunkSCHBLK77_cjs.LinkableEntityType.NOTICE,
    target: chunkSCHBLK77_cjs.LinkableEntityType.EVENT,
    linkType: chunkSCHBLK77_cjs.EntityLinkType.SCHEDULE
  },
  {
    source: chunkSCHBLK77_cjs.LinkableEntityType.MAINTENANCE_LOG,
    target: chunkSCHBLK77_cjs.LinkableEntityType.EVENT,
    linkType: chunkSCHBLK77_cjs.EntityLinkType.SCHEDULE
  },
  {
    source: chunkSCHBLK77_cjs.LinkableEntityType.FAILURE_REPORT,
    target: chunkSCHBLK77_cjs.LinkableEntityType.EVENT,
    linkType: chunkSCHBLK77_cjs.EntityLinkType.SCHEDULE
  },
  {
    source: chunkSCHBLK77_cjs.LinkableEntityType.FAILURE_REPORT,
    target: chunkSCHBLK77_cjs.LinkableEntityType.MAINTENANCE_LOG,
    linkType: chunkSCHBLK77_cjs.EntityLinkType.RESOLVED_BY
  },
  {
    source: chunkSCHBLK77_cjs.LinkableEntityType.MAINTENANCE_LOG,
    target: chunkSCHBLK77_cjs.LinkableEntityType.POLL,
    linkType: chunkSCHBLK77_cjs.EntityLinkType.BASED_ON
  },
  {
    source: chunkSCHBLK77_cjs.LinkableEntityType.EXPENSE_TRANSACTION,
    target: chunkSCHBLK77_cjs.LinkableEntityType.MAINTENANCE_LOG,
    linkType: chunkSCHBLK77_cjs.EntityLinkType.EXPENSE_FOR
  },
  { source: "*", target: "*", linkType: chunkSCHBLK77_cjs.EntityLinkType.RELATED_TO }
];
...
var ALL_READS = [
  ...chunkSCHBLK77_cjs.domainPermissions("building", "read"),
  ...chunkSCHBLK77_cjs.domainPermissions("user", "read"),
  ...chunkSCHBLK77_cjs.domainPermissions("notice", "read"),
  ...chunkSCHBLK77_cjs.domainPermissions("event", "read"),
  ...chunkSCHBLK77_cjs.domainPermissions("poll", "read"),
  ...chunkSCHBLK77_cjs.domainPermissions("failure_report", "read"),
  ...chunkSCHBLK77_cjs.domainPermissions("maintenance_log", "read"),
  ...chunkSCHBLK77_cjs.domainPermissions("financial", "read"),
  ...chunkSCHBLK77_cjs.domainPermissions("document", "read"),
  ...chunkSCHBLK77_cjs.domainPermissions("unit", "read"),
  ...chunkSCHBLK77_cjs.domainPermissions("apartment", "read"),
...
var RESIDENT_PERMISSIONS = [
  ...
  ...chunkSCHBLK77_cjs.domainPermissions("notice", "own"),
  ...chunkSCHBLK77_cjs.domainPermissions("event", "own"),
  ...chunkSCHBLK77_cjs.domainPermissions("poll", "own"),
  "poll:vote",
  ...chunkSCHBLK77_cjs.domainPermissions("failure_report", "own"),
  ...chunkSCHBLK77_cjs.domainPermissions("document", "own"),
  "user:delete:own"
];
...
var REPRESENTATIVE_PERMISSIONS = [
  ...
  ...chunkSCHBLK77_cjs.domainPermissions("notice", "manage"),
  ...chunkSCHBLK77_cjs.domainPermissions("event", "manage"),
  ...chunkSCHBLK77_cjs.domainPermissions("poll", "manage"),
  ...chunkSCHBLK77_cjs.domainPermissions("failure_report", "manage"),
  ...chunkSCHBLK77_cjs.domainPermissions("document", "manage"),
  "notice:approve",
  "notice:pin",
  ...
  "financial:update",
  "financial:delete",
  ...chunkSCHBLK77_cjs.domainPermissions("maintenance_log", "manage"),
...
var BUILDING_ROLE_PERMISSIONS = {
  [chunkSCHBLK77_cjs.BuildingRole.RESIDENT]: unique(RESIDENT_PERMISSIONS),
  [chunkSCHBLK77_cjs.BuildingRole.CO_OWNER]: unique(CO_OWNER_PERMISSIONS),
  [chunkSCHBLK77_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: unique(REPRESENTATIVE_PERMISSIONS),
  [chunkSCHBLK77_cjs.BuildingRole.OWNER_REPRESENTATIVE]: unique(REPRESENTATIVE_PERMISSIONS)
};
var ORG_ROLE_PERMISSIONS = {
  [chunkSCHBLK77_cjs.OrgRole.ORG_ADMIN]: unique([...ORG_ADMIN_BUILDING_PERMISSIONS, ...ORG_ADMIN_ORG_PERMISSIONS]),
  [chunkSCHBLK77_cjs.OrgRole.SUPERVISOR]: unique([...SUPERVISOR_BUILDING_PERMISSIONS, ...SUPERVISOR_ORG_PERMISSIONS]),
  [chunkSCHBLK77_cjs.OrgRole.REFERENT]: unique([...REFERENT_BUILDING_PERMISSIONS, ...REFERENT_ORG_PERMISSIONS]),
  [chunkSCHBLK77_cjs.OrgRole.OPERATIVE]: unique([...OPERATIVE_BUILDING_PERMISSIONS, ...OPERATIVE_ORG_PERMISSIONS])
};
var PLATFORM_ROLE_PERMISSIONS = {
  [chunkSCHBLK77_cjs.PlatformRole.PLATFORM_ADMIN]: [
  ...
  [chunkSCHBLK77_cjs.PlatformRole.PLATFORM_MODERATOR]: [
    "platform:approve_buildings",
    "platform:manage_users",
    "platform:manage_orgs",
    "platform:view_orgs",
  ...
  [chunkSCHBLK77_cjs.PlatformRole.PLATFORM_SUPPORT]: [
    "platform:approve_buildings",
    "platform:view_orgs",
    "platform:view_analytics",
    "platform:moderate_content"
  ],
  [chunkSCHBLK77_cjs.PlatformRole.PLATFORM_OPERATIVE]: ["platform:view_analytics"]
};
var ALL_PERMISSIONS = unique(Object.values(chunkSCHBLK77_cjs.Permission));
var ADMIN_ORG_PERMISSIONS = ORG_ROLE_PERMISSIONS[chunkSCHBLK77_cjs.OrgRole.ORG_ADMIN];
var ADMIN_PLATFORM_PERMISSIONS = PLATFORM_ROLE_PERMISSIONS[chunkSCHBLK77_cjs.PlatformRole.PLATFORM_ADMIN];
...
//# sourceMappingURL=chunk-TTTDZ4NF.cjs.map
//# sourceMappingURL=chunk-TTTDZ4NF.cjs.map