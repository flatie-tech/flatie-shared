...
function canDoOnResource(ctx, domain, action, resourceOwnerId) {
  if (ctx.kind === "admin") return true;
  const scopedPerms = chunkFVDJCFES_cjs.SCOPED_PERMISSIONS[domain]?.[action];
...
function computeActionFlags(ctx, domain, resourceOwnerId) {
  const approvePermission = chunkFVDJCFES_cjs.APPROVE_PERMISSIONS[domain];
  return {
...
var ROLE_TRANSLATION_KEYS = {
  // Building roles
  [chunkFVDJCFES_cjs.BuildingRole.OWNER_REPRESENTATIVE]: "roles.OWNER_REPRESENTATIVE",
  [chunkFVDJCFES_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: "roles.DEPUTY_REPRESENTATIVE",
  [chunkFVDJCFES_cjs.BuildingRole.CO_OWNER]: "roles.CO_OWNER",
  // Org roles
  [chunkFVDJCFES_cjs.OrgRole.ORG_ADMIN]: "roles.ORG_ADMIN",
  [chunkFVDJCFES_cjs.OrgRole.SUPERVISOR]: "roles.SUPERVISOR",
  [chunkFVDJCFES_cjs.OrgRole.REFERENT]: "roles.REFERENT",
  [chunkFVDJCFES_cjs.OrgRole.OPERATIVE]: "roles.OPERATIVE",
  // Platform roles
  [chunkFVDJCFES_cjs.PlatformRole.PLATFORM_ADMIN]: "roles.PLATFORM_ADMIN",
  [chunkFVDJCFES_cjs.PlatformRole.PLATFORM_MODERATOR]: "roles.PLATFORM_MODERATOR",
  [chunkFVDJCFES_cjs.PlatformRole.PLATFORM_SUPPORT]: "roles.PLATFORM_SUPPORT",
  [chunkFVDJCFES_cjs.PlatformRole.PLATFORM_OPERATIVE]: "roles.PLATFORM_OPERATIVE"
};
var ROLE_DESCRIPTION_KEYS = {
  [chunkFVDJCFES_cjs.BuildingRole.OWNER_REPRESENTATIVE]: "roles.OWNER_REPRESENTATIVE_DESC",
  [chunkFVDJCFES_cjs.BuildingRole.DEPUTY_REPRESENTATIVE]: "roles.DEPUTY_REPRESENTATIVE_DESC",
  [chunkFVDJCFES_cjs.BuildingRole.CO_OWNER]: "roles.CO_OWNER_DESC",
  [chunkFVDJCFES_cjs.OrgRole.ORG_ADMIN]: "roles.ORG_ADMIN_DESC",
  [chunkFVDJCFES_cjs.OrgRole.SUPERVISOR]: "roles.SUPERVISOR_DESC",
  [chunkFVDJCFES_cjs.OrgRole.REFERENT]: "roles.REFERENT_DESC",
  [chunkFVDJCFES_cjs.OrgRole.OPERATIVE]: "roles.OPERATIVE_DESC",
  [chunkFVDJCFES_cjs.PlatformRole.PLATFORM_ADMIN]: "roles.PLATFORM_ADMIN_DESC",
  [chunkFVDJCFES_cjs.PlatformRole.PLATFORM_MODERATOR]: "roles.PLATFORM_MODERATOR_DESC",
  [chunkFVDJCFES_cjs.PlatformRole.PLATFORM_SUPPORT]: "roles.PLATFORM_SUPPORT_DESC",
  [chunkFVDJCFES_cjs.PlatformRole.PLATFORM_OPERATIVE]: "roles.PLATFORM_OPERATIVE_DESC"
};

// src/utils/status-variants.ts
function failureStatusVariant(status) {
  switch (status) {
    case chunkFVDJCFES_cjs.FailureStatus.PENDING:
      return "info";
    case chunkFVDJCFES_cjs.FailureStatus.IN_PROGRESS:
      return "warning";
    case chunkFVDJCFES_cjs.FailureStatus.RESOLVED:
      return "success";
    default:
      return "neutral";
  }
...
function priorityVariant(priority) {
  switch (priority) {
    case chunkFVDJCFES_cjs.Priority.URGENT:
      return "danger";
    case chunkFVDJCFES_cjs.Priority.NORMAL:
      return "neutral";
    default:
      return "neutral";
  }
...
//# sourceMappingURL=chunk-UTB6LVZY.cjs.map
//# sourceMappingURL=chunk-UTB6LVZY.cjs.map